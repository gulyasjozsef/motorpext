...
const assetVersion = "20260630-language-cleanup";
let currentPrefix = "";
let currentLang = "ro";
let currentPathName = "/";
...
const services = [
  {
    ...
    heroText: "Mașina trage într-o parte, volanul nu stă drept sau anvelopele se uzează neuniform? Verificăm geometria roților și readucem direcția în parametri.",
    ...
    symptomsTitle: "Când se recomandă reglajul direcției?",
    symptoms: [
      "Mașina trage într-o parte",
      "Volanul nu stă drept",
      "Anvelopele se uzează neuniform",
      "Impact cu bordură sau groapă",
      "Componente de direcție sau suspensie schimbate",
      "Mașina este instabilă la viteze mai mari",
    ],
    explanationTitle: "Ce presupune reglajul direcției?",
    explanationIntro: "O geometrie incorectă schimbă felul în care mașina stă pe drum: direcția devine imprecisă, anvelopele se pot uza prematur, iar condusul devine obositor. Valorile sunt măsurate, abaterile sunt verificate, iar reglajul se face acolo unde starea tehnică permite.",
    explanationBlocks: [
      ["Măsurare pe echipament dedicat", "Verificăm poziția roților și identificăm abaterea care poate provoca instabilitate sau uzură neuniformă."],
      ["Reglaj în parametri", "Corectăm unghiurile pentru o direcție mai precisă și o mașină mai ușor de controlat."],
      ["Verificare componente conexe", "Dacă valorile nu pot fi corectate, căutăm semne de uzură la direcție, suspensie sau anvelope."],
      ["Recomandare după măsurare", "Valorile măsurate, reglajele efectuate și recomandările tehnice sunt comunicate clar."],
    ],
    ...
    process: [
      ["Discuție și verificare", "Comportamentul mașinii la rulare este corelat cu elementele care pot influența geometria."],
      ["Măsurare geometrie roți", "Citirea valorilor arată unde este abaterea și cât de mult afectează rularea."],
      ["Reglaj direcție", "Aducem unghiurile în parametri atunci când mașina permite reglajul corect."],
      ["Confirmare finală", "Rezultatul este verificat, iar eventualele lucrări recomandate sunt comunicate clar."],
    ],
    ctaQuestion: "Reglaj direcție în Oradea",
    related: ["mecanica-auto-oradea", "service-anvelope-oradea", "frane-suspensie-oradea", "diagnoza-auto-oradea"],
    faqs: [
      ["Când este necesar reglajul direcției?", "Reglajul este recomandat când mașina trage într-o parte, volanul nu stă drept, anvelopele se uzează neuniform sau după lucrări la direcție ori suspensie."],
  ...
  },
  {
    ...
    metaDescription: "Încărcare freon în Oradea cu verificarea instalației de climă. Evaluare pentru încărcare corectă sau identificarea pierderilor.",
    heroText: "Clima nu mai răcește cum trebuie? Verificăm presiunea și starea instalației înainte de completarea cu agent frigorific.",
    image: imageUrls.ac,
    ...
    captionText: "Nu încărcăm la întâmplare: verificăm dacă sistemul funcționează în parametri.",
    symptomsTitle: "Când se recomandă verificarea climei auto?",
    symptoms: [
      ...
      "Instalație neverificată de mult timp",
    ],
    explanationTitle: "Ce include serviciul de climă auto?",
    explanationIntro: "Răcirea slabă nu înseamnă automat doar lipsă de freon. Poate fi o pierdere, o presiune incorectă sau o componentă care nu mai lucrează bine. De aceea verificăm instalația înainte să recomandăm încărcarea.",
    explanationBlocks: [
      ...
      ["Încărcare freon", "Agentul frigorific este completat doar când verificările confirmă că lucrarea este justificată tehnic."],
      ["Control funcționare", "Testăm răcirea și răspunsul sistemului după încărcare."],
      ["Recomandări tehnice", "Dacă sunt necesare reparații suplimentare, recomandările sunt comunicate clar."],
    ],
    warning: {
      title: "Încărcarea cu freon nu rezolvă orice problemă",
      text: "Dacă instalația pierde agent frigorific, o simplă reîncărcare poate ține puțin. Verificarea cauzei reduce riscul vizitelor repetate la service.",
    },
    ...
    process: [
      ["Verificare inițială", "Funcționarea sistemului de climatizare este verificată înainte de completarea cu agent frigorific."],
      ["Control presiune și funcționare", "Evaluăm presiunea și comportamentul sistemului."],
      ["Încărcare freon dacă este necesar", "Reîncărcarea se face doar când lucrarea este justificată tehnic."],
      ["Test final", "Răcirea este confirmată, iar eventualele recomandări sunt comunicate clar."],
    ],
    ctaQuestion: "Încărcare freon în Oradea",
    ...
    faqs: [
      ...
      ["Este suficientă doar încărcarea cu freon?", "Nu întotdeauna. Dacă există pierderi sau componente defecte, încărcarea fără verificare rezolvă doar temporar efectul vizibil."],
      ["Cât de des trebuie verificată clima auto?", "Este recomandată o verificare periodică, mai ales înainte de sezonul cald sau când eficiența de răcire scade."],
      ["Se poate circula cu clima defectă?", "Da, însă verificarea instalației este recomandată. Unele probleme pot afecta confortul, dezaburirea și durata de viață a compresorului."],
    ],
  },
  {
    ...
    heroText: "Dacă aerul nu mai răcește, apare miros neplăcut sau sistemul pierde agent frigorific, identificăm cauza și reparăm instalația de climatizare.",
    ...
    explanationIntro: "Sistemul de climatizare depinde de presiune, etanșeitate, senzori, compresor, ventilatoare și comandă electrică. Fiecare zonă este verificată logic, astfel încât reparația tratează cauza, nu doar efectul vizibil.",
    ...
    ctaQuestion: "Reparații climă auto în Oradea",
  ...
  },
  {
    ...
    heroText: "Martor aprins, pornire grea sau pierdere de putere? Erorile sunt citite, datele sunt corelate cu verificarea tehnică, iar cauza reală este stabilită înainte de reparație.",
    ...
    captionText: "Datele din diagnoză sunt corelate cu verificarea tehnică a mașinii.",
    ...
    explanationIntro: "Un cod de eroare indică o direcție, nu un verdict. Codurile sunt corelate cu verificări tehnice, astfel încât reparația pornește de la date, nu de la presupuneri.",
    ...
    ctaQuestion: "Diagnoză auto în Oradea",
  ...
  },
  {
    ...
    heroText: "Zgomote, vibrații, scurgeri sau revizie întârziată? Ansamblurile mecanice sunt verificate, prioritățile sunt stabilite, iar lucrările necesare sunt comunicate clar înainte de reparație.",
    image: imageUrls.mechanic,
    imageAlt: "Mecanic realizând reparații auto într-un atelier profesionist",
    captionTitle: "Constatare mecanică și deviz clar",
    captionText: "Lucrarea este stabilită pe baza verificării tehnice și a priorității componentelor.",
    symptomsTitle: "Când se recomandă verificarea mecanică?",
    ...
    explanationIntro: "O reparație bună începe cu o constatare corectă. Comportamentul mașinii la rulare este corelat cu verificarea componentelor relevante, pentru a stabili ce este urgent, ce poate fi planificat și ce lucrare rezolvă cauza.",
    explanationBlocks: genericBlocks("mecanică auto"),
    benefits: ["Siguranță la condus", "Întreținere corectă", "Durată de viață mai bună pentru componente", "Costuri transparente", "Service multimarcă"],
    process: genericProcess("mecanică auto"),
    ctaQuestion: "Mecanică auto în Oradea",
  ...
  },
  {
    ...
    heroText: "Probleme la pornire, senzori, baterie sau martori aprinși? Testăm sistemele electrice și izolăm cauza înainte de reparație.",
    ...
    captionText: "Circuitul electric și componentele sunt testate înainte de recomandarea reparației.",
    ...
    explanationIntro: "Defecțiunile electrice pot apărea intermitent și pot avea cauze ascunse. Diagnoza este completată cu testări pe circuit, pentru identificarea corectă a componentelor afectate și evitarea înlocuirilor inutile.",
    ...
    ctaQuestion: "Electrică auto în Oradea",
  ...
  },
  {
    ...
    secondaryKeywords: ["Verificare injectoare Oradea", "Sistem injecție diesel Oradea", "Service injecție Oradea"],
    metaTitle: "Verificare injecție Oradea | MOTORPEXT",
    metaDescription: "Verificare injecție în Oradea pentru pornire greoaie, fum, consum crescut sau motor neregulat. Constatare tehnică și recomandări clare.",
    heroText: "Motorul pornește greu, scoate fum sau tremură? Sistemul de injecție este verificat, iar recomandările sunt stabilite pe baza constatării.",
    ...
    explanationIntro: "Problemele de injecție pot afecta pornirea, consumul, fumul și puterea motorului. Funcționarea sistemului și componentele relevante sunt verificate înainte de recomandarea reparației.",
    explanationBlocks: genericBlocks("sistem de injecție"),
    benefits: ["Claritate tehnică", "Reparații recomandate corect", "Protecție pentru motor", "Consum mai eficient", "Verificare specializată"],
    process: genericProcess("sistem de injecție"),
    ctaQuestion: "Verificare injecție în Oradea",
  ...
  },
  {
    ...
    heroText: "Lovituri, zgârieturi sau elemente deformate? Dauna este evaluată, metoda potrivită este stabilită, iar pașii lucrării sunt prezentați clar.",
    ...
    symptomsTitle: "Când sunt recomandate tinichigeria sau vopsitoria?",
    ...
    explanationIntro: "Fiecare daună cere o abordare diferită: îndreptare, pregătire, vopsire locală sau înlocuire. Evaluăm zona afectată și alegem varianta care poate oferi un rezultat curat și durabil.",
    ...
    ctaQuestion: "Tinichigerie și vopsitorie în Oradea",
  ...
  },
  {
    ...
    heroText: "Vibrații, presiune care scade sau anvelope uzate neuniform? Roțile sunt verificate pentru rulare stabilă, frânare bună și uzură controlată.",
    ...
    symptomsTitle: "Când se recomandă verificarea anvelopelor?",
    ...
    explanationIntro: "Anvelopele sunt contactul direct cu drumul. Starea lor influențează frânarea, stabilitatea, confortul și consumul. Roțile sunt verificate, iar lucrările necesare pentru rulare sigură sunt recomandate pe baza constatării.",
    ...
    ctaQuestion: "Service anvelope în Oradea",
  ...
  },
  {
    ...
    heroText: "Zgomote la frânare, vibrații sau instabilitate? Frânele și suspensia sunt verificate pentru oprire sigură și comportament predictibil.",
    ...
    explanationIntro: "Frânele și suspensia influențează direct oprirea, stabilitatea și controlul mașinii. Componentele importante sunt inspectate, uzura este identificată, iar lucrările necesare pentru siguranță sunt comunicate clar.",
    explanationBlocks: genericBlocks("frâne și suspensie"),
    benefits: ["Siguranță mai bună", "Stabilitate crescută", "Frânare predictibilă", "Protecție pentru anvelope", "Reparații transparente"],
    process: genericProcess("frâne și suspensie"),
    ctaQuestion: "Verificare frâne și suspensie în Oradea",
...
function genericBlocks(context) {
  return [
    ["Constatare tehnică", `Verificarea pornește de la comportamentul mașinii și de la componentele relevante pentru ${context}.`],
    ["Identificarea cauzei", "Cauza reală este stabilită înainte de recomandarea înlocuirilor sau a lucrărilor mai costisitoare."],
    ["Lucrare justificată tehnic", "Lucrarea începe după clarificarea motivului tehnic, a pieselor vizate și a rezultatului urmărit."],
    ["Recomandări clare", "La final sunt comunicate lucrările efectuate, observațiile tehnice și recomandările pentru perioada următoare."],
  ];
}

function genericProcess(context) {
  return [
    ["Preluare și verificare", `Comportamentul semnalat este analizat, apoi este verificată zona de ${context}.`],
    ["Constatare tehnică", "Sunt identificate componentele relevante, cauza probabilă și prioritatea lucrărilor."],
    ["Lucrare agreată", "Reparația începe după stabilirea opțiunilor și confirmarea direcției de lucru."],
    ["Control final", "Rezultatul este verificat, iar recomandările tehnice pentru perioada următoare sunt comunicate clar."],
  ];
}

function genericFaq(topic, noun) {
  return [
    [`Când este recomandat serviciul de ${topic}?`, "Este recomandat când comportamentul mașinii se schimbă, când apar zgomote, vibrații, erori sau când este necesară o verificare preventivă."],
    [`Cât durează ${noun}?`, "Durata depinde de starea mașinii și de rezultatul constatării. După verificare se comunică o estimare realistă."],
    ["Este necesară programarea?", "Pentru o vizită rapidă și bine organizată, programarea se face în prealabil."],
    ["Sunt comunicate recomandările înainte de reparație?", "Da. Constatarea, recomandările tehnice și opțiunile disponibile sunt comunicate înainte de începerea lucrării."],
...
function header() {
  ...
  <div class="container header-inner">
    ...
    <div class="header-actions">
      ...
      <a class="btn btn-primary" href="${homeHref("#programare")}">Programare</a>
    </div>
  </div>
</header>`;
}
...
function footer() {
  ...
  <div class="container footer-bottom">
    ...
    <span>Service auto Oradea · Autorizat R.A.R.</span>
  </div>
</footer>`;
}
...
function localBusinessSchema() {
  return {
    ...
    areaServed: "Oradea",
    priceRange: "$$",
    description: "Service auto autorizat R.A.R. în Oradea, cu experiență din 1994 și servicii multimarcă pentru întreținere și reparații auto.",
  };
}
...
function homePage() {
  ...
  const heroSlides = [
    {
      ...
      text: "Constatare tehnică, reparații multimarcă și întreținere auto realizate cu deviz clar, comunicare transparentă și lucrări verificate.",
  ...
  <div class="home-hero-slides" aria-hidden="true">
    ${heroSlides.map((slide, index) => `<div class="home-hero-slide home-hero-slide-${index + 1}${index === 0 ? " is-active" : ""}" style="--hero-image: url('${cssAssetPath(slide.image)}')"></div>`).join("")}
  </div>
  <div class="container home-hero-inner">
    <div class="home-hero-content">
      ...
      <div class="hero-actions">
        <a class="btn btn-primary" href="tel:+40744532370">Programare</a>
        <a class="btn btn-secondary" href="#servicii">Servicii</a>
      </div>
    </div>
...
<section class="section section-services" id="servicii">
  <div class="container">
    <div class="section-heading-row">
      ...
      <p class="section-lead">Servicii auto prezentate clar, cu verificări tehnice, recomandări profesioniste și lucrări stabilite înainte de reparație.</p>
    </div>
...
<section class="section section-dark fleet-section" id="flota-auto" style="--fleet-image:url('${cssAssetPath(imageUrls.fleet)}')">
  <div class="container fleet-grid">
    <div class="fleet-copy">
      ...
      <p class="section-lead">Pentru companii, timpul pierdut în service înseamnă costuri. Programările sunt organizate, lucrările sunt prioritizate, iar flota rămâne pregătită pentru activitatea zilnică.</p>
      <div class="fleet-actions">
        <a class="btn btn-primary" href="${homeHref("#programare")}">Programare flotă</a>
        <a class="btn btn-ghost" href="tel:+40744532370">Telefon flotă</a>
      </div>
    </div>
    <div class="fleet-benefits">
      ${[
        ["Programări organizate", "Planificăm vizitele astfel încât vehiculele să stea cât mai puțin în service."],
        ["Reparații multimarcă", "Lucrăm pe autoturisme și utilitare ușoare, cu verificare tehnică atentă."],
        ["Priorități clare", "Lucrările urgente, cele planificabile și costurile anticipate sunt comunicate transparent."],
        ["Partener local în Oradea", "Un service local cu experiență susține lucrările curente ale flotei."],
...
<section class="section workflow-section">
  <div class="container">
    <div class="section-heading-row">
      ...
      <p class="section-lead">Proces clar, de la programare și constatare până la deviz, lucrare și control final.</p>
    </div>
    <div class="workflow-grid">
      ${[
        ["Programare", "Programarea se face telefonic, cu detalii despre mașină și lucrarea solicitată."],
        ["Constatare tehnică", "Mașina este verificată pe baza sistemului vizat, a datelor disponibile și a componentelor relevante."],
        ["Deviz și recomandare", "Recomandarea tehnică, costurile și prioritățile sunt comunicate înainte de începerea lucrării."],
        ["Lucrare și control final", "Lucrarea agreată este executată, iar rezultatul este verificat înainte de predarea mașinii."],
...
<section class="section why-proof-section">
  <div class="container why-proof-grid">
    <div class="why-proof-panel">
      ...
      <h2 class="section-title">Service auto local, cu deviz clar și lucrări verificate</h2>
      <p class="section-lead">La Motorpext, constatarea tehnică este baza fiecărei recomandări. Lucrările sunt stabilite transparent, în funcție de starea mașinii, prioritatea reparației și siguranța în utilizare.</p>
      <div class="proof-meta">
        <span>Autorizat R.A.R.</span>
        <span>Din 1994</span>
        <span>${currentLang === "hu" ? "Nagyvárad" : "Oradea"}</span>
      </div>
    </div>
    <div class="check-grid why-proof-cards">
      ${[
        ["Experiență din 1994", "Ani de lucru cu probleme reale, pe mașini și sisteme diferite."],
        ["Personal calificat", "O echipă atentă la constatare, execuție și verificarea finală."],
        ["Echipamente moderne", "Verificări potrivite pentru mașini actuale și sisteme complexe."],
        ["Costuri transparente", "Devizul este comunicat înainte de lucrare, cu priorități clare."],
        ["Lucrări justificate tehnic", "Recomandările sunt făcute în funcție de constatarea mașinii."],
        ["Comunicare clară", "Informațiile importante sunt transmise direct, profesionist și ușor de urmărit."],
...
<section class="section-tight" id="programare">
  <div class="container">
    ${ctaBand("Verificare auto în Oradea", "Pentru zgomote, erori, pierderi de lichide sau comportament neobișnuit, programarea la service se face telefonic.", "Telefon: 0744 532 370")}
  </div>
</section>
  ...
  return `<section class="cta-band" aria-labelledby="programare-rapida">
    <div class="cta-content">
      ...
      <div class="cta-actions">
        ...
        <a class="btn btn-secondary" href="${homeHref("#contact")}">Programare</a>
      </div>
    </div>
  </section>`;
}
...
function contactSection(extraClass = "") {
  ...
  <div class="container">
    <div class="section-heading-row">
      ...
      <p class="section-lead">Programarea, disponibilitatea și detaliile despre lucrare se stabilesc telefonic cu atelierul Motorpext.</p>
    </div>
...
function servicePage(service) {
  ...
  <div class="container">
    <div class="service-hero-content">
      ...
      <div class="hero-actions">
        <a class="btn btn-primary" href="tel:+40744532370">Telefon</a>
        <a class="btn btn-secondary" href="${homeHref("#contact")}">Programare</a>
      </div>
    </div>
  </div>
...
<section class="section section-white service-symptoms-section">
  <div class="container">
    <div class="centered">
      <span class="section-kicker">Semne</span>
      <h2 class="section-title">${service.symptomsTitle}</h2>
      <p class="section-lead">Aceste semne arată că mașina are nevoie de o verificare tehnică înainte ca defecțiunea să genereze costuri mai mari.</p>
    </div>
...
<section class="section service-explain-section">
  <div class="container explain-grid">
    <div>
      <span class="section-kicker">Detalii tehnice</span>
...
<section class="section section-white service-benefits-section">
  <div class="container">
    <div class="centered">
      ...
      <p class="section-lead">Scopul este o mașină verificată corect, cu lucrări justificate tehnic și cu mai multă siguranță în utilizare.</p>
    </div>
    <div class="benefit-grid" style="margin-top:42px">
      ${service.benefits.map((item) => `<article class="info-card"><span class="card-icon">${icon("check")}</span><h3>${item}</h3><p>${benefitDescription(service, item)}</p></article>`).join("")}
    </div>
  </div>
</section>
...
<section class="section service-process-section">
  <div class="container">
    <div class="section-heading-row">
      ...
      <p class="section-lead">Pașii principali sunt clari de la început: constatare, deviz, lucrare și control final.</p>
    </div>
...
<section class="section-tight service-cta-section">
  <div class="container">
    ${ctaBand(service.ctaQuestion, "Pentru verificare tehnică și programare la service, contactul se face telefonic.", "Telefon: 0744 532 370")}
  </div>
</section>
...
function benefitDescription(service, benefit) {
  if (benefit === "Confort mai bun") {
    if (service.slug === "service-anvelope-oradea") {
      return "Roțile echilibrate și anvelopele potrivite reduc vibrațiile și zgomotele la rulare.";
    }
    return "Un sistem de climatizare reparat corect oferă aer rece, curat și constant.";
  }

  const specific = {
    "Siguranță mai bună la condus": "Direcția corect reglată ajută mașina să rămână predictibilă la schimbări de bandă, frânare și viraje.",
    "Uzură uniformă a anvelopelor": "O geometrie corectă reduce solicitarea inutilă a anvelopelor și ajută la o uzură mai echilibrată.",
    "Stabilitate crescută": "Mașina se simte mai așezată pe drum, mai ales la viteze mai mari sau pe trasee lungi.",
    "Consum optimizat": "Când roțile rulează corect, mașina nu lucrează împotriva propriei geometrii.",
    "Protecție pentru suspensie și direcție": "Corectarea abaterilor reduce solicitările care pot afecta în timp componentele de direcție și suspensie.",
    "Răcire eficientă": "Sistemul verificat corect poate răci mai bine și mai constant în zilele calde.",
    "Confort la condus": "O climă funcțională contribuie la confort și ajută la dezaburire atunci când este necesar.",
    "Protecție pentru compresor": "Verificarea presiunii și a funcționării ajută la evitarea solicitării inutile a compresorului.",
    "Funcționare corectă a sistemului": "Testăm răspunsul instalației, nu doar completarea cu agent frigorific.",
    "Diagnostic clar înainte de reparații": "Se stabilește dacă este suficientă încărcarea sau dacă există o defecțiune care trebuie reparată.",
    "Funcționare corectă": "Reparația urmărește cauza problemei, nu o soluție temporară.",
    "Diagnostic clar": "Verificarea pas cu pas arată ce componentă trebuie reparată sau înlocuită.",
    "Reducerea riscului de defecțiuni repetate": "Când cauza este identificată, scade riscul să revii cu aceeași problemă.",
    "Identificare mai rapidă": "Diagnoza corelată cu verificarea tehnică scurtează drumul de la problemă la soluție.",
    "Decizii informate": "Eroarea, opțiunile de reparație și prioritățile sunt comunicate înainte de lucrare.",
    "Costuri mai bine controlate": "O constatare bună reduce riscul schimbărilor de piese făcute din presupuneri.",
    "Reparații orientate corect": "Lucrarea pornește de la date și verificări, nu de la presupuneri.",
    "Comunicare clară": "Explicațiile sunt formulate clar, pentru o înțelegere corectă a situației mașinii.",
    "Siguranță la condus": "Componentele verificate și întreținute corect fac mașina mai sigură în utilizarea zilnică.",
    "Întreținere corectă": "Lucrările făcute la timp pot preveni defecțiuni mai mari și costuri neprevăzute.",
    "Durată de viață mai bună pentru componente": "O problemă rezolvată corect protejează piesele care lucrează împreună.",
    "Costuri transparente": "Lucrarea necesară și motivul apariției în deviz sunt comunicate clar.",
    "Service multimarcă": "Lucrăm pe mărci și modele diferite, cu abordare adaptată fiecărei mașini.",
    "Identificare precisă": "Testările electrice reduc riscul lucrărilor pe componenta greșită.",
    "Funcționare stabilă": "Circuitul verificat corect ajută sistemele electrice să funcționeze predictibil.",
    "Mai puține probleme recurente": "Este verificată cauza defecțiunilor intermitente, nu doar codul de eroare.",
    "Recomandări clare": "Este comunicat ce este important imediat și ce poate fi urmărit în timp.",
    "Aspect îmbunătățit": "O reparație de caroserie bine făcută readuce mașina mai aproape de aspectul dorit.",
    "Reparații corecte": "Alegem metoda de lucru potrivită pentru tipul și zona daunei.",
    "Protecție pentru caroserie": "Pregătirea și repararea corectă ajută la protejarea zonei afectate.",
    "Evaluare clară": "Înainte de lucrare se stabilește ce se poate repara și ce rezultat este realist.",
    "Execuție profesionistă": "Lucrările sunt făcute cu atenție la detalii și la aspectul final.",
    "Rulare mai stabilă": "Roțile verificate corect ajută mașina să se simtă mai sigură pe drum.",
    "Siguranță la frânare": "Anvelopele în stare bună contribuie direct la distanța și controlul la frânare.",
    "Uzură controlată": "Verificarea roților ajută la depistarea problemelor care duc la uzură prematură.",
    "Siguranță mai bună": "Frânele și suspensia în stare bună ajută mașina să reacționeze corect în situații importante.",
    "Frânare predictibilă": "Un sistem de frânare verificat contribuie la mai mult control în trafic.",
    "Protecție pentru anvelope": "Suspensia și direcția influențează modul în care anvelopele se uzează.",
    "Reparații transparente": "Componenta afectată și motivul recomandării sunt comunicate clar.",
    "Claritate tehnică": "Sunt verificate datele relevante înainte de recomandarea lucrării pe sistemul de injecție.",
    "Reparații recomandate corect": "Sunt indicate lucrările justificate și aspectele care trebuie urmărite, fără operațiuni inutile.",
    "Protecție pentru motor": "Un sistem de injecție verificat corect ajută motorul să funcționeze mai curat și mai stabil.",
    "Consum mai eficient": "Când injecția lucrează corect, motorul poate folosi combustibilul mai eficient.",
    "Verificare specializată": "Abordare tehnică atentă pentru sistemele de injecție diesel.",
  };
  if (specific[benefit]) return specific[benefit];
  return `Sunt verificate elementele care influențează ${service.navTitle.toLowerCase()}, iar recomandarea tehnică este comunicată înainte de lucrare.`;
}
...
function privacyPage() {
  ...
  <section class="section section-white">
    <div class="container about-panel">
      ...
      <p>Acest website prezintă informații despre serviciile SC MOTORPEXT SRL și include date de contact pentru solicitări de programare. Pentru întrebări privind datele personale, contactul se poate face la numerele afișate pe site.</p>
    </div>
  </section>`;
  return shell({
...
const translationEntries = {
  hu: [
    ...
    ["SC MOTORPEXT SRL este un service auto autorizat RAR în Oradea, cu experiență din 1994. Diagnoză auto, mecanică, electrică, reglaj direcție, climă și întreținere auto.", "Az SC MOTORPEXT SRL RAR engedéllyel rendelkező autószerviz Nagyváradon, 1994 óta működő tapasztalattal. Autódiagnosztika, autószerelés, autóvillamosság, futóműállítás, klímaszerviz és autókarbantartás."],
    ...
    ["Programează o vizită la service", "Szervizidőpont egyeztetése"],
    ["Frânele și suspensia influențează direct oprirea, stabilitatea și controlul mașinii. Componentele importante sunt inspectate, uzura este identificată, iar lucrările necesare pentru siguranță sunt comunicate clar.", "A fék és a futómű közvetlenül befolyásolja a megállást, a stabilitást és az autó irányíthatóságát. A fontos alkatrészek ellenőrzése után a kopás és a biztonság szempontjából szükséges munkák világosan kommunikálásra kerülnek."],
  ...
  en: [
    ...
    ["Programează-te", "Appointment"],
    ["Sună acum", "Phone"],
    ["Sună: 0744 532 370", "Call: 0744 532 370"],
    ["Află mai multe", "Details"],
    ["Detalii", "Details"],
    ["Contact", "Contact"],
    ["Telefon", "Phone"],
    ["Adresă", "Address"],
    ...
    ["Programează o vizită la service", "Workshop appointment"],
    ["Frânele și suspensia influențează direct oprirea, stabilitatea și controlul mașinii. Componentele importante sunt inspectate, uzura este identificată, iar lucrările necesare pentru siguranță sunt comunicate clar.", "Brakes and suspension directly influence stopping, stability and vehicle control. Important components are inspected, wear is identified and the work needed for safety is communicated clearly."],
...
function cleanupLocalizedHtml(html, lang) {
  if (lang === "hu") {
    return html
      ...
      .replace(/Telefon flotă/g, "Flotta telefon")
      .replace(/Verificare auto Nagyváradon/g, "Autóellenőrzés Nagyváradon")
      .replace(/Când se recomandă ellenőrzés mecanică\?/g, "Mikor ajánlott a mechanikai ellenőrzés?")
      .replace(/Când se recomandă ellenőrzés anvelopelor\?/g, "Mikor ajánlott a gumiabroncsok ellenőrzése?")
      .replace(/Când sunt recomandate tinichigeria sau vopsitoria\?/g, "Mikor ajánlott karosszéria- vagy fényezési munka?")
      .replace(/Când se recomandă reglajul direcției\?/g, "Mikor ajánlott a futóműállítás?")
      .replace(/Sistemul de klímarendszer depinde de presiune, etanșeitate, senzori, compresor, ventilatoare și comandă electrică\. Fiecare zonă este verificată logic, astfel încât javítás tratează cauza, nu doar efectul vizibil\./g, "A klímarendszer működése a nyomástól, tömítettségtől, érzékelőktől, kompresszortól, ventilátoroktól és elektromos vezérléstől is függ. Minden terület logikusan kerül ellenőrzésre, hogy a javítás a hiba okát kezelje, ne csak a látható következményt.")
      .replace(/Un sistem de klímarendszer reparat corect oferă aer rece, curat și constant\./g, "A megfelelően javított klímarendszer hideg, tiszta és egyenletes levegőt biztosít.")
      .replace(/Reparația urmărește cauza problemei, nu o soluție temporară\./g, "A javítás a hiba okát kezeli, nem ideiglenes megoldást ad.")
      .replace(/Lucrarea necesară și motivul apariției în deviz sunt comunicate clar\./g, "A szükséges munka és az árajánlatban szereplő indok világosan kerül egyeztetésre.")
      .replace(/Este comunicat ce este important imediat și ce poate fi urmărit în timp\./g, "Világosan egyeztetésre kerül, mi fontos azonnal, és mit érdemes később figyelni.")
      .replace(/Înainte de lucrare se stabilește ce se poate repara și ce rezultat este realist\./g, "A munka előtt tisztázásra kerül, mi javítható, és milyen eredmény reális.")
      .replace(/Testările electrice reduc riscul lucrărilor pe componenta greșită\./g, "Az elektromos tesztek csökkentik annak kockázatát, hogy rossz alkatrészen történjen munka.")
      .replace(/Diagnoza corelată cu ellenőrzés tehnică scurtează drumul de la problemă la soluție\./g, "A diagnosztika és a műszaki ellenőrzés összevetése lerövidíti az utat a hibától a megoldásig.")
      .replace(/Eroarea, opțiunile de reparație și prioritățile sunt comunicate înainte de lucrare\./g, "A hibakód, a javítási lehetőségek és a prioritások a munka megkezdése előtt kerülnek egyeztetésre.")
      .replace(/Lucrarea pornește de la date și verificări, nu de la presupuneri\./g, "A munka adatokból és ellenőrzésekből indul ki, nem feltételezésekből.")
      .replace(/Explicațiile sunt formulate clar, pentru o înțelegere corectă a situației mașinii\./g, "A magyarázatok világosan, az autó állapotának pontos megértését segítve készülnek.")
      .replace(/Este verificată cauza defecțiunilor intermitente, nu doar codul de eroare\./g, "Az időszakos hibák oka kerül ellenőrzésre, nem csak a hibakód.")
      .replace(/Motorul pornește greu, scoate fum sau tremură\? Sistemul de befecskendezés este verificat, iar recomandările sunt stabilite pe baza constatării\./g, "Nehéz indítás, füstölés vagy egyenetlen motorjárás esetén a befecskendező rendszer ellenőrzése után a javaslatok a műszaki hibafeltárás alapján készülnek.")
      .replace(/Verificare fék és futómű Nagyváradon/g, "Fék és futómű ellenőrzés Nagyváradon")
      .replace(/O geometrie incorectă schimbă felul în care mașina stă pe drum: direcția devine imprecisă, anvelopele se pot uza prematur, iar condusul devine obositor\. Valorile sunt măsurate, abaterile sunt verificate, iar reglajul se face acolo unde starea tehnică permite\./g, "A hibás kerékgeometria megváltoztatja az autó úttartását: pontatlanabbá válhat a kormányzás, idő előtt kophatnak az abroncsok, és fárasztóbb lehet a vezetés. Az értékek mérése után az eltérések ellenőrzésre kerülnek, a beállítás pedig ott történik meg, ahol az autó műszaki állapota ezt lehetővé teszi.")
      .replace(/Măsurare pe echipament dedicat/g, "Mérés dedikált berendezéssel")
      .replace(/Reglaj în parametri/g, "Paraméterek beállítása")
      .replace(/Verificare componente conexe/g, "Kapcsolódó alkatrészek ellenőrzése")
      .replace(/Recomandare după măsurare/g, "Javaslat mérés után")
      .replace(/Confirmare finală/g, "Végső ellenőrzés")
      .replace(/Anvelopele sunt contactul direct cu drumul\. Starea lor influențează frânarea, stabilitatea, confortul și consumul\. Roțile sunt verificate, iar lucrările necesare pentru rulare sigură sunt recomandate pe baza constatării\./g, "Az abroncs az autó közvetlen kapcsolata az úttal. Állapota befolyásolja a fékezést, stabilitást, komfortot és fogyasztást. A kerekek ellenőrzése után a biztonságos futáshoz szükséges munkák a hibafeltárás alapján kerülnek javaslatra.")
      .replace(/Str\. Santăului nr\. 1, Oradea/g, "Santăului utca 1., Nagyvárad")
      .replace(/SC MOTORPEXT SRL · Oradea/g, "SC MOTORPEXT SRL · Nagyvárad")
      .replace(/Service auto Oradea · Autorizat R\.A\.R\./g, "Autószerviz Nagyvárad · R.A.R. engedély")
      .replace(/Service auto multimarcă în Oradea/g, "többmárkás autószerviz Nagyváradon")
  ...
  if (lang === "en") {
    return html
      ...
      .replace(/Phone flotă/g, "Fleet phone")
      .replace(/Verificare auto in Oradea/g, "Vehicle check in Oradea")
      .replace(/Verificare brakes and suspension in Oradea/g, "Brake and suspension check in Oradea")
      .replace(/Când se recomandă the check mecanică\?/g, "When is a mechanical check recommended?")
      .replace(/Când se recomandă the check anvelopelor\?/g, "When is a tire check recommended?")
      .replace(/Când sunt recomandate tinichigeria sau vopsitoria\?/g, "When are bodywork or painting services recommended?")
      .replace(/Când se recomandă reglajul direcției\?/g, "When is wheel alignment recommended?")
      .replace(/Sistemul de air conditioning depinde de presiune, etanșeitate, senzori, compresor, ventilatoare și comandă electrică\. Fiecare zonă este verificată logic, astfel încât the repair tratează cauza, nu doar efectul vizibil\./g, "The air conditioning system depends on pressure, sealing, sensors, compressor, fans and electrical control. Each area is checked logically so the repair addresses the cause, not only the visible effect.")
      .replace(/Un sistem de air conditioning reparat corect oferă aer rece, curat și constant\./g, "A correctly repaired AC system provides cold, clean and consistent air.")
      .replace(/Reparația urmărește cauza problemei, nu o soluție temporară\./g, "The repair targets the cause of the problem, not a temporary workaround.")
      .replace(/Diagnoza corelată cu the check tehnică scurtează drumul de la problemă la soluție\./g, "Diagnostics correlated with the technical check shorten the path from problem to solution.")
      .replace(/Eroarea, opțiunile de reparație și prioritățile sunt comunicate înainte de lucrare\./g, "The error, repair options and priorities are communicated before work begins.")
      .replace(/Lucrarea necesară și motivul apariției în deviz sunt comunicate clar\./g, "The required work and the reason it appears in the estimate are communicated clearly.")
      .replace(/Lucrarea pornește de la date și verificări, nu de la presupuneri\./g, "The work starts from data and checks, not assumptions.")
      .replace(/Explicațiile sunt formulate clar, pentru o înțelegere corectă a situației mașinii\./g, "Explanations are clear, making the vehicle situation easy to understand.")
      .replace(/Testările electrice reduc riscul lucrărilor pe componenta greșită\./g, "Electrical tests reduce the risk of working on the wrong component.")
      .replace(/Este verificată cauza defecțiunilor intermitente, nu doar codul de eroare\./g, "The cause of intermittent faults is checked, not only the error code.")
      .replace(/Este comunicat ce este important imediat și ce poate fi urmărit în timp\./g, "It is made clear what matters immediately and what can be monitored over time.")
      .replace(/Înainte de lucrare se stabilește ce se poate repara și ce rezultat este realist\./g, "Before work begins, it is clarified what can be repaired and what result is realistic.")
      .replace(/Motorul pornește greu, scoate fum sau tremură\? Sistemul de injection este verificat, iar recomandările sunt stabilite pe baza constatării\./g, "For hard starting, smoke or uneven engine operation, the injection system is checked and recommendations are based on the technical inspection.")
      .replace(/O geometrie incorectă schimbă felul în care mașina stă pe drum: direcția devine imprecisă, anvelopele se pot uza prematur, iar condusul devine obositor\. Valorile sunt măsurate, abaterile sunt verificate, iar reglajul se face acolo unde starea tehnică permite\./g, "Incorrect wheel geometry changes how the car sits on the road: steering can become imprecise, tires may wear prematurely and driving can become tiring. Values are measured, deviations are checked and adjustment is made where the vehicle condition allows it.")
      .replace(/Măsurare pe echipament dedicat/g, "Measurement on dedicated equipment")
      .replace(/Reglaj în parametri/g, "Adjustment within parameters")
      .replace(/Verificare componente conexe/g, "Related component check")
      .replace(/Recomandare după măsurare/g, "Recommendation after measurement")
      .replace(/Confirmare finală/g, "Final confirmation")
      .replace(/Anvelopele sunt contactul direct cu drumul\. Starea lor influențează frânarea, stabilitatea, confortul și consumul\. Roțile sunt verificate, iar lucrările necesare pentru rulare sigură sunt recomandate pe baza constatării\./g, "Tires are the vehicle's direct contact with the road. Their condition affects braking, stability, comfort and consumption. Wheels are checked, and work needed for safe driving is recommended based on the inspection.")
      .replace(/Str\. Santăului nr\. 1, Oradea/g, "1 Santăului Street, Oradea")
      .replace(/Service auto Oradea · Autorizat R\.A\.R\./g, "Auto repair Oradea · R.A.R. authorized")
...
function genericTranslationEntries(lang) {
  const hu = [
    ["Str. Santăului nr. 1, Oradea", "Santăului utca 1., Nagyvárad"],
    ["SC MOTORPEXT SRL · Oradea", "SC MOTORPEXT SRL · Nagyvárad"],
    ["Service auto Oradea · Autorizat R.A.R.", "Autószerviz Nagyvárad · R.A.R. engedély"],
    ["Service auto autorizat R.A.R. în Oradea, cu experiență din 1994 și servicii multimarcă pentru întreținere și reparații auto.", "RAR engedéllyel rendelkező autószerviz Nagyváradon, 1994 óta működő tapasztalattal és többmárkás karbantartási, javítási szolgáltatásokkal."],
    ["Încărcare freon în Oradea cu verificarea instalației de climă. Evaluare pentru încărcare corectă sau identificarea pierderilor.", "Klímatöltés Nagyváradon a klímarendszer ellenőrzésével. Műszaki felmérés a helyes töltéshez vagy a szivárgás azonosításához."],
    ["Când se recomandă verificarea climei auto?", "Mikor ajánlott az autóklíma ellenőrzése?"],
    ["Dacă instalația pierde agent frigorific, o simplă reîncărcare poate ține puțin. Verificarea cauzei reduce riscul vizitelor repetate la service.", "Ha a rendszer hűtőközeget veszít, az egyszerű újratöltés csak rövid ideig tart. Az ok ellenőrzése csökkenti az ismételt szervizlátogatások kockázatát."],
    ["Este recomandată o verificare periodică, mai ales înainte de sezonul cald sau când eficiența de răcire scade.", "Időszakos ellenőrzés ajánlott, különösen a meleg szezon előtt vagy a hűtési teljesítmény csökkenésekor."],
    ["Se poate circula cu clima defectă?", "Lehet hibás klímával közlekedni?"],
    ["Da, însă verificarea instalației este recomandată. Unele probleme pot afecta confortul, dezaburirea și durata de viață a compresorului.", "Igen, de a rendszer ellenőrzése ajánlott. Egyes hibák befolyásolhatják a komfortot, a páramentesítést és a kompresszor élettartamát."],
    ["Verificare injecție Oradea | MOTORPEXT", "Befecskendezés ellenőrzés Nagyvárad | MOTORPEXT"],
    ["Verificare injecție în Oradea pentru pornire greoaie, fum, consum crescut sau motor neregulat. Constatare tehnică și recomandări clare.", "Befecskendezés ellenőrzés Nagyváradon nehéz indításhoz, füstöléshez, magas fogyasztáshoz vagy egyenetlen motorjáráshoz. Műszaki hibafeltárás és világos javaslatok."],
    ["Service injecție Oradea", "Befecskendezés szerviz Nagyvárad"],
    ["Verificare specializată", "Speciális ellenőrzés"],
    ["Abordare tehnică atentă pentru sistemele de injecție diesel.", "Alapos műszaki megközelítés dízel befecskendező rendszerekhez."],
    ["Constatare tehnică, reparații multimarcă și întreținere auto realizate cu deviz clar, comunicare transparentă și lucrări verificate.", "Műszaki hibafeltárás, többmárkás javítás és autókarbantartás világos árajánlattal, átlátható kommunikációval és ellenőrzött munkával."],
    ["Servicii auto prezentate clar, cu verificări tehnice, recomandări profesioniste și lucrări stabilite înainte de reparație.", "Átlátható autószerviz-szolgáltatások műszaki ellenőrzéssel, professzionális javaslatokkal és javítás előtt egyeztetett munkákkal."],
    ["Pentru companii, timpul pierdut în service înseamnă costuri. Programările sunt organizate, lucrările sunt prioritizate, iar flota rămâne pregătită pentru activitatea zilnică.", "Cégek esetében a szervizben töltött idő költséget jelent. Az időpontok szervezetten történnek, a munkák prioritás szerint haladnak, a flotta pedig készen áll a napi működésre."],
    ["Programare flotă", "Flottaidőpont"],
    ["Un service local cu experiență susține lucrările curente ale flotei.", "Tapasztalt helyi szervizpartner támogatja a flotta rendszeres munkáit."],
    ["Proces clar, de la programare și constatare până la deviz, lucrare și control final.", "Világos folyamat az időpontfoglalástól és hibafeltárástól az árajánlaton, munkán és végső ellenőrzésen át."],
    ["Programarea se face telefonic, cu detalii despre mașină și lucrarea solicitată.", "Az időpontfoglalás telefonon történik, az autó és a kért munka részleteinek egyeztetésével."],
    ["Mașina este verificată pe baza sistemului vizat, a datelor disponibile și a componentelor relevante.", "Az autó ellenőrzése az érintett rendszer, a rendelkezésre álló adatok és a releváns alkatrészek alapján történik."],
    ["Recomandarea tehnică, costurile și prioritățile sunt comunicate înainte de începerea lucrării.", "A műszaki javaslat, a költségek és a prioritások a munka megkezdése előtt kerülnek egyeztetésre."],
    ["Lucrarea agreată este executată, iar rezultatul este verificat înainte de predarea mașinii.", "Az egyeztetett munka elkészül, az eredmény pedig az autó átadása előtt ellenőrzésre kerül."],
    ["Service auto local, cu deviz clar și lucrări verificate", "Helyi autószerviz világos árajánlattal és ellenőrzött munkával"],
    ["La Motorpext, constatarea tehnică este baza fiecărei recomandări. Lucrările sunt stabilite transparent, în funcție de starea mașinii, prioritatea reparației și siguranța în utilizare.", "A Motorpextnél minden javaslat alapja a műszaki hibafeltárás. A munkák átláthatóan, az autó állapota, a javítás sürgőssége és a használati biztonság alapján kerülnek meghatározásra."],
    ["Costuri transparente", "Átlátható költségek"],
    ["Devizul este comunicat înainte de lucrare, cu priorități clare.", "Az árajánlat a munka előtt, világos prioritásokkal kerül egyeztetésre."],
    ["Lucrări justificate tehnic", "Műszakilag indokolt munkák"],
    ["Recomandările sunt făcute în funcție de constatarea mașinii.", "A javaslatok az autó műszaki hibafeltárása alapján készülnek."],
    ["Informațiile importante sunt transmise direct, profesionist și ușor de urmărit.", "A fontos információk egyértelműen, professzionálisan és követhetően kerülnek átadásra."],
    ["Pentru zgomote, erori, pierderi de lichide sau comportament neobișnuit, programarea la service se face telefonic.", "Zajok, hibakódok, folyadékszivárgás vagy szokatlan viselkedés esetén a szervizidőpont egyeztetése telefonon történik."],
    ["Programarea, disponibilitatea și detaliile despre lucrare se stabilesc telefonic cu atelierul Motorpext.", "Az időpont, az elérhetőség és a munka részletei telefonon egyeztethetők a Motorpext műhellyel."],
    ["Lucrările urgente, cele planificabile și costurile anticipate sunt comunicate transparent.", "A sürgős, tervezhető munkák és a várható költségek átláthatóan kerülnek egyeztetésre."],
    ["Semne", "Jelek"],
    ["Deviz și recomandare", "Árajánlat és javaslat"],
    ["Preluare și verificare", "Átvétel és ellenőrzés"],
    ["Lucrare justificată tehnic", "Műszakilag indokolt munka"],
    ["Impact cu bordură sau groapă", "Padka- vagy kátyúütés"],
    ["Componente de direcție sau suspensie schimbate", "Cserélt kormány- vagy futóműalkatrészek"],
    ["Instalație neverificată de mult timp", "Régen ellenőrzött klímarendszer"],
    ["Reglajul este recomandat când mașina trage într-o parte, volanul nu stă drept, anvelopele se uzează neuniform sau după lucrări la direcție ori suspensie.", "A futóműállítás akkor ajánlott, ha az autó félrehúz, a kormány nem áll egyenesen, az abroncsok egyenetlenül kopnak, vagy kormány-, illetve futóműmunkák történtek."],
    ["O climă funcțională contribuie la confort și ajută la dezaburire atunci când este necesar.", "A működő klímarendszer kényelmesebb utazást és szükség esetén hatékony páramentesítést biztosít."],
    ["Se stabilește dacă este suficientă încărcarea sau dacă există o defecțiune care trebuie reparată.", "Megállapításra kerül, hogy elegendő-e a töltés, vagy javítandó hiba áll fenn."],
    ["Răcirea este confirmată, iar eventualele recomandări sunt comunicate clar.", "A hűtés ellenőrzése megtörténik, az esetleges javaslatok pedig világosan átadásra kerülnek."],
    ["Aceste semne arată că mașina are nevoie de o verificare tehnică înainte ca defecțiunea să genereze costuri mai mari.", "Ezek a jelek műszaki ellenőrzést indokolnak, mielőtt a hiba nagyobb költséget okozna."],
    ["Detalii tehnice", "Műszaki részletek"],
    ["Scopul este o mașină verificată corect, cu lucrări justificate tehnic și cu mai multă siguranță în utilizare.", "A cél a megfelelően ellenőrzött autó, műszakilag indokolt munkákkal és nagyobb használati biztonsággal."],
    ["Pașii principali sunt clari de la început: constatare, deviz, lucrare și control final.", "A fő lépések kezdettől világosak: hibafeltárás, árajánlat, munka és végső ellenőrzés."],
    ["Pentru verificare tehnică și programare la service, contactul se face telefonic.", "Műszaki ellenőrzéshez és szervizidőponthoz a kapcsolatfelvétel telefonon történik."],
    ["Verificarea pornește de la comportamentul mașinii și de la componentele relevante pentru", "Az ellenőrzés az autó viselkedéséből és a releváns alkatrészekből indul ki ezen a területen:"],
    ["Cauza reală este stabilită înainte de recomandarea înlocuirilor sau a lucrărilor mai costisitoare.", "A valódi ok meghatározása megelőzi a cserék vagy költségesebb munkák javaslatát."],
    ["Lucrarea începe după clarificarea motivului tehnic, a pieselor vizate și a rezultatului urmărit.", "A munka a műszaki indok, az érintett alkatrészek és a kívánt eredmény tisztázása után kezdődik."],
    ["La final sunt comunicate lucrările efectuate, observațiile tehnice și recomandările pentru perioada următoare.", "A végén az elvégzett munka, a műszaki észrevételek és a következő időszakra vonatkozó javaslatok kerülnek átadásra."],
    ["Comportamentul semnalat este analizat, apoi este verificată zona de", "A jelzett működés elemzése után az ellenőrzés ezen a területen történik:"],
    ["Sunt identificate componentele relevante, cauza probabilă și prioritatea lucrărilor.", "Meghatározásra kerülnek a releváns alkatrészek, a valószínű ok és a munkák prioritása."],
    ["Reparația începe după stabilirea opțiunilor și confirmarea direcției de lucru.", "A javítás a lehetőségek tisztázása és a munka irányának jóváhagyása után kezdődik."],
    ["Rezultatul este verificat, iar recomandările tehnice pentru perioada următoare sunt comunicate clar.", "Az eredmény ellenőrzése után a következő időszakra vonatkozó műszaki javaslatok világosan átadásra kerülnek."],
    ["Este recomandat când comportamentul mașinii se schimbă, când apar zgomote, vibrații, erori sau când este necesară o verificare preventivă.", "Akkor ajánlott, ha megváltozik az autó viselkedése, zaj, vibráció, hibakód jelenik meg, vagy megelőző ellenőrzés szükséges."],
    ["Durata depinde de starea mașinii și de rezultatul constatării. După verificare se comunică o estimare realistă.", "Az időtartam az autó állapotától és a hibafeltárás eredményétől függ. Ellenőrzés után reális becslés készül."],
    ["Pentru o vizită rapidă și bine organizată, programarea se face în prealabil.", "Gyors és jól szervezett látogatáshoz az időpontfoglalás előzetesen történik."],
    ["Sunt comunicate recomandările înainte de reparație?", "A javítás előtt átadásra kerülnek a javaslatok?"],
    ["Da. Constatarea, recomandările tehnice și opțiunile disponibile sunt comunicate înainte de începerea lucrării.", "Igen. A hibafeltárás, a műszaki javaslatok és az elérhető lehetőségek a munka megkezdése előtt egyeztetésre kerülnek."],
    ["Valorile măsurate, reglajele efectuate și recomandările tehnice sunt comunicate clar.", "A mért értékek, az elvégzett beállítások és a műszaki javaslatok világosan átadásra kerülnek."],
    ["Comportamentul mașinii la rulare este corelat cu elementele care pot influența geometria.", "Az autó menet közbeni viselkedése összevetésre kerül a geometriát befolyásoló elemekkel."],
    ["Agentul frigorific este completat doar când verificările confirmă că lucrarea este justificată tehnic.", "A hűtőközeg pótlása csak akkor történik, ha az ellenőrzés műszakilag indokolja a munkát."],
    ["Funcționarea sistemului de climatizare este verificată înainte de completarea cu agent frigorific.", "A klímarendszer működése a hűtőközeg pótlása előtt ellenőrzésre kerül."],
    ["Reîncărcarea se face doar când lucrarea este justificată tehnic.", "Az újratöltés csak műszakilag indokolt esetben történik."],
    ["Nu întotdeauna. Dacă există pierderi sau componente defecte, încărcarea fără verificare rezolvă doar temporar efectul vizibil.", "Nem mindig. Szivárgás vagy hibás alkatrész esetén az ellenőrzés nélküli töltés csak ideiglenesen kezeli a látható következményt."],
    ["Martor aprins, pornire grea sau pierdere de putere? Erorile sunt citite, datele sunt corelate cu verificarea tehnică, iar cauza reală este stabilită înainte de reparație.", "Világító hibajelzés, nehéz indítás vagy teljesítményvesztés esetén a hibakódok kiolvasása és az adatok műszaki ellenőrzéssel való összevetése megelőzi a javítást."],
    ["Datele din diagnoză sunt corelate cu verificarea tehnică a mașinii.", "A diagnosztikai adatok az autó műszaki ellenőrzésével kerülnek összevetésre."],
    ["Un cod de eroare indică o direcție, nu un verdict. Codurile sunt corelate cu verificări tehnice, astfel încât reparația pornește de la date, nu de la presupuneri.", "A hibakód irányt mutat, nem végleges ítélet. A kódok műszaki ellenőrzéssel kerülnek összevetésre, így a javítás adatokból indul ki, nem feltételezésből."],
    ["Zgomote, vibrații, scurgeri sau revizie întârziată? Ansamblurile mecanice sunt verificate, prioritățile sunt stabilite, iar lucrările necesare sunt comunicate clar înainte de reparație.", "Zaj, vibráció, szivárgás vagy késedelmes szerviz esetén a mechanikai egységek ellenőrzése után a prioritások és a szükséges munkák világosan egyeztetésre kerülnek."],
    ["Constatare mecanică și deviz clar", "Mechanikai hibafeltárás és világos árajánlat"],
    ["Lucrarea este stabilită pe baza verificării tehnice și a priorității componentelor.", "A munka műszaki ellenőrzés és alkatrész-prioritás alapján kerül meghatározásra."],
    ["O reparație bună începe cu o constatare corectă. Comportamentul mașinii la rulare este corelat cu verificarea componentelor relevante, pentru a stabili ce este urgent, ce poate fi planificat și ce lucrare rezolvă cauza.", "A jó javítás korrekt hibafeltárással kezdődik. Az autó menet közbeni viselkedése a releváns alkatrészek ellenőrzésével kerül összevetésre, így meghatározható, mi sürgős, mi tervezhető és milyen munka oldja meg az okot."],
    ["Circuitul electric și componentele sunt testate înainte de recomandarea reparației.", "Az elektromos kör és az alkatrészek a javítási javaslat előtt ellenőrzésre kerülnek."],
    ["Defecțiunile electrice pot apărea intermitent și pot avea cauze ascunse. Diagnoza este completată cu testări pe circuit, pentru identificarea corectă a componentelor afectate și evitarea înlocuirilor inutile.", "Az elektromos hibák időszakosan jelentkezhetnek és rejtett okkal is bírhatnak. A diagnosztikát áramköri tesztek egészítik ki az érintett alkatrészek pontos azonosításához és a felesleges cserék elkerüléséhez."],
    ["Problemele de injecție pot afecta pornirea, consumul, fumul și puterea motorului. Funcționarea sistemului și componentele relevante sunt verificate înainte de recomandarea reparației.", "A befecskendezési hibák hatással lehetnek az indításra, fogyasztásra, füstölésre és motorteljesítményre. A rendszer működése és a releváns alkatrészek a javítási javaslat előtt ellenőrzésre kerülnek."],
    ["Reparații transparente", "Átlátható javítások"],
    ["Componenta afectată și motivul recomandării sunt comunicate clar.", "Az érintett alkatrész és a javaslat oka világosan átadásra kerül."],
    ["Sunt verificate datele relevante înainte de recomandarea lucrării pe sistemul de injecție.", "A befecskendező rendszeren végzett munka javaslata előtt a releváns adatok ellenőrzésre kerülnek."],
    ["Sunt indicate lucrările justificate și aspectele care trebuie urmărite, fără operațiuni inutile.", "A műszakilag indokolt munkák és a figyelendő pontok kerülnek megjelölésre, felesleges műveletek nélkül."],
    ["Când apar semne de defecțiune, sunt necesare o constatare corectă, explicații clare și o intervenție făcută responsabil.", "Meghibásodásra utaló jelek esetén korrekt hibafeltárásra, világos magyarázatra és felelősen elvégzett beavatkozásra van szükség."],
    ["Servicii structurate clar, cu informații despre situațiile în care sunt recomandate și despre modul de verificare înainte de intervenție.", "Átlátható szolgáltatások, egyértelmű információkkal arról, mikor ajánlottak és hogyan történik az ellenőrzés a beavatkozás előtt."],
    ["Martor aprins, pornire grea sau pierdere de putere? Erorile sunt citite, simptomele sunt verificate, iar cauza reală este căutată înainte de reparație.", "Világító hibajelzés, nehéz indítás vagy teljesítményvesztés esetén a hibakódok kiolvasása, a tünetek ellenőrzése és a valós ok feltárása megelőzi a javítást."],
    ["Zgomote, vibrații, scurgeri sau revizie amânată? Mașina este verificată, prioritățile sunt stabilite, iar lucrările necesare sunt explicate clar.", "Zaj, vibráció, szivárgás vagy elhalasztott szerviz esetén az autó ellenőrzése után világos prioritások és érthető javítási javaslatok készülnek."],
    ["Probleme la pornire, senzori, baterie sau martori aprinși? Testăm sistemele electrice și izolăm cauza înainte de reparație.", "Indítási gond, szenzorhiba, akkumulátorprobléma vagy világító hibajelzés esetén az elektromos rendszerek tesztelése és az ok elkülönítése megelőzi a javítást."],
    ["Lovituri, zgârieturi sau elemente deformate? Dauna este evaluată, metoda potrivită este stabilită, iar pașii lucrării sunt prezentați clar.", "Horpadás, karc vagy deformált elem esetén a sérülés felmérése után meghatározható a megfelelő módszer és a munka menete."],
    ["Vibrații, presiune care scade sau anvelope uzate neuniform? Roțile sunt verificate pentru rulare stabilă, frânare bună și uzură controlată.", "Vibráció, csökkenő nyomás vagy egyenetlen abroncskopás esetén a kerekek ellenőrzése stabil futást, jobb fékezést és kontrollált kopást támogat."],
    ["Zgomote la frânare, vibrații sau instabilitate? Frânele și suspensia sunt verificate pentru oprire sigură și comportament predictibil.", "Fékezéskor jelentkező zaj, vibráció vagy instabilitás esetén a fék és futómű ellenőrzése biztonságos megállást és kiszámítható viselkedést szolgál."],
    ["Lucrările urgente, cele planificabile și costurile anticipate sunt comunicate transparent.", "A sürgős, tervezhető munkák és a várható költségek átláthatóan kerülnek kommunikálásra."],
    ["Un service local cu experiență poate susține intervențiile curente ale flotei.", "Tapasztalt helyi szervizpartner támogatja a flotta rendszeres beavatkozásait."],
    ["Proces etapizat, cu verificări clare, recomandări tehnice și decizii luate înainte de începerea reparației.", "Lépésről lépésre felépített folyamat, világos ellenőrzésekkel, műszaki ajánlásokkal és javítás előtti döntésekkel."],
    ["Simptomele observate sunt discutate, apoi se stabilește momentul potrivit pentru verificare.", "Az észlelt tünetek egyeztetése után meghatározható az ellenőrzés megfelelő időpontja."],
    ["Constatarea, recomandările și intervenția propusă sunt explicate înainte de lucru.", "A hibafeltárás, az ajánlások és a javasolt beavatkozás a munka megkezdése előtt kerül bemutatásra."],
    ["Lucrarea agreată este executată, rezultatul este verificat, iar recomandările finale sunt comunicate clar.", "Az egyeztetett munka elvégzése után az eredmény ellenőrzése és a végső ajánlások kommunikálása következik."],
    ["La Motorpext, constatarea vine înaintea presupunerilor. Recomandările sunt făcute pe baza verificărilor, cu explicații clare și lucrări orientate spre funcționarea corectă a mașinii.", "A Motorpextnél a hibafeltárás megelőzi a feltételezéseket. Az ajánlások ellenőrzések alapján készülnek, világos magyarázatokkal és az autó megfelelő működését célzó munkákkal."],
    ["Lucrarea este discutată înainte, cu explicații clare despre costuri.", "A munka előzetes egyeztetéssel és a költségek világos magyarázatával történik."],
    ["Explicații clare, fără presiune inutilă și fără recomandări forțate.", "Világos magyarázat, felesleges nyomás és erőltetett ajánlások nélkül."],
    ["Pentru simptome observate la mașină, următorul pas este o constatare clară și o programare la service.", "Autón észlelt tünetek esetén a következő lépés az egyértelmű hibafeltárás és a szervizidőpont egyeztetése."],
    ["Pentru disponibilitate, detalii despre lucrare sau programare, atelierul Motorpext poate fi contactat telefonic.", "Elérhetőség, munkarészletek vagy időpont egyeztetése telefonon történhet a Motorpext műhellyel."],
    ["Acest website prezintă informații despre serviciile SC MOTORPEXT SRL și include date de contact pentru solicitări de programare. Pentru întrebări privind datele personale, contactul se poate face la numerele afișate pe site.", "Ez a weboldal az SC MOTORPEXT SRL szolgáltatásairól ad tájékoztatást, és időpontkéréshez szükséges elérhetőségeket tartalmaz. Személyes adatokkal kapcsolatos kérdésekben a weboldalon megadott telefonszámokon lehet kapcsolatba lépni."],
    ["Aceste semne indică faptul că o verificare la timp poate preveni reparații mai costisitoare.", "Ezek a jelek arra utalhatnak, hogy az időben elvégzett ellenőrzés megelőzheti a költségesebb javításokat."],
    ["Scopul este o mașină verificată corect, cu explicații clare și cu mai multă siguranță la utilizare.", "A cél a megfelelően ellenőrzött autó, világos magyarázatokkal és nagyobb használati biztonsággal."],
    ["Pașii principali sunt clari dinainte, iar după constatare sunt comunicate recomandările necesare pentru decizie.", "A fő lépések előre világosak, a hibafeltárás után pedig a döntéshez szükséges ajánlások is egyértelműen kommunikálásra kerülnek."],
    ["Pentru simptome observate la mașină, se recomandă o constatare tehnică și o programare pentru verificare.", "Autón észlelt tünetek esetén műszaki hibafeltárás és ellenőrzési időpont egyeztetése ajánlott."],
    ["Este recomandat când apar simptome neobișnuite, când comportamentul mașinii se schimbă sau când o problemă trebuie verificată înainte să devină mai costisitoare.", "Akkor ajánlott, ha szokatlan tünetek jelennek meg, megváltozik az autó viselkedése, vagy egy problémát még a költségesebbé válás előtt ellenőrizni kell."],
    ["Durata depinde de starea mașinii și de ce se descoperă la constatare. După verificare se poate comunica o estimare realistă.", "Az időtartam az autó állapotától és a hibafeltárás eredményétől függ. Ellenőrzés után reális becslés adható."],
    ["Este necesară programarea?", "Szükséges az időpontfoglalás?"],
    ["Pentru o vizită mai rapidă și mai bine organizată, este recomandată programarea în prealabil.", "Gyorsabb és szervezettebb látogatáshoz előzetes időpontfoglalás ajánlott."],
    ["Sunt explicate recomandările înainte de reparație?", "A javítás előtt ismertetésre kerülnek az ajánlások?"],
    ["Da. Constatarea, recomandările și opțiunile disponibile sunt comunicate înainte de începerea lucrării.", "Igen. A hibafeltárás, az ajánlások és az elérhető lehetőségek a munka megkezdése előtt kerülnek kommunikálásra."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru diagnoză.", "Az ellenőrzés az észlelt tünetekből és a diagnosztika szempontjából releváns elemekből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru mecanică auto.", "Az ellenőrzés az észlelt tünetekből és a mechanikai szempontból releváns alkatrészekből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru electrică auto.", "Az ellenőrzés az észlelt tünetekből és az autóvillamosság szempontjából releváns elemekből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru climatizare.", "Az ellenőrzés az észlelt tünetekből és a klímarendszer releváns elemeiből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru sistem de injecție.", "Az ellenőrzés az észlelt tünetekből és a befecskendező rendszer releváns elemeiből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru caroserie.", "Az ellenőrzés az észlelt tünetekből és a karosszéria érintett elemeiből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru anvelope.", "Az ellenőrzés az észlelt tünetekből és a kerekek, abroncsok releváns elemeiből indul ki."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru frâne și suspensie.", "Az ellenőrzés az észlelt tünetekből és a fék, illetve futómű releváns elemeiből indul ki."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de diagnoză.", "Az észlelt tünetek elemzése után a diagnosztikai terület ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de mecanică auto.", "Az észlelt tünetek elemzése után a mechanikai terület ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de electrică auto.", "Az észlelt tünetek elemzése után az autóvillamossági terület ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de climatizare.", "Az észlelt tünetek elemzése után a klímarendszer ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de sistem de injecție.", "Az észlelt tünetek elemzése után a befecskendező rendszer ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de caroserie.", "Az észlelt tünetek elemzése után a karosszéria érintett területének ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de anvelope.", "Az észlelt tünetek elemzése után a kerekek és abroncsok ellenőrzése következik."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de frâne și suspensie.", "Az észlelt tünetek elemzése után a fék és futómű ellenőrzése következik."],
    ["Urmărim motivul real al problemei înainte să recomandăm înlocuiri sau lucrări mai costisitoare.", "A drágább cserék vagy munkák ajánlása előtt a probléma valódi oka kerül vizsgálatra."],
    ["Lucrarea agreată începe după clarificarea intervenției, a motivului tehnic și a rezultatului urmărit.", "Az egyeztetett munka a beavatkozás, a műszaki indok és az elérni kívánt eredmény tisztázása után kezdődik."],
    ["La final sunt comunicate indicații clare despre ce merită urmărit și ce poate fi planificat mai departe.", "A végén világos információ készül arról, mire érdemes figyelni és mit lehet későbbre tervezni."],
    ["Intervenția începe după stabilirea opțiunilor și confirmarea direcției de lucru.", "A beavatkozás a lehetőségek tisztázása és a munka irányának jóváhagyása után kezdődik."],
    ["Rezultatul este verificat, iar recomandările utile pentru perioada următoare sunt comunicate clar.", "Az eredmény ellenőrzése után a következő időszakra hasznos ajánlások is világosan kommunikálásra kerülnek."],
    ["Dacă sunt necesare reparații suplimentare, recomandările sunt comunicate clar.", "További javítás szükségessége esetén az ajánlások világosan kommunikálásra kerülnek."],
    ["Rezultatul este prezentat clar: ce s-a constatat, ce s-a reglat și ce merită urmărit.", "Az eredmény világosan bemutatja, mi került megállapításra, mi lett beállítva, és mire érdemes figyelni."],
    ["Simptomele observate la volan sunt corelate cu elementele care pot influența geometria.", "A vezetés közben észlelt tünetek összevetésre kerülnek a geometriát befolyásoló elemekkel."],
    ["Rezultatul este verificat, iar eventualele lucrări recomandate sunt comunicate clar.", "Az eredmény ellenőrzése után az esetlegesen ajánlott munkák világosan kommunikálásra kerülnek."],
    ["Un sistem de frânare verificat contribuie la mai mult control în trafic.", "Az ellenőrzött fékrendszer nagyobb kontrollt támogat a forgalomban."],
    ["Componenta afectată și motivul recomandării sunt explicate clar.", "Az érintett alkatrész és az ajánlás oka világosan kerül ismertetésre."],
    ["Când mașina îți dă un semn, ai nevoie de o constatare corectă, explicații pe înțeles și o lucrare făcută responsabil.", "Amikor az autó jelez valamit, korrekt hibafeltárásra, érthető magyarázatra és felelősen elvégzett munkára van szükség."],
    ["Clima nu mai răcește cum trebuie? Verificăm presiunea și starea instalației înainte de completarea cu agent frigorific.", "Nem hűt rendesen a klíma? A hűtőközeg pótlása előtt ellenőrizzük a nyomást és a rendszer állapotát."],
    ["Mașina trage într-o parte, volanul nu stă drept sau anvelopele se uzează neuniform? Verificăm geometria roților și readucem direcția în parametri.", "Félrehúz az autó, nem áll egyenesen a kormány, vagy egyenetlenül kopnak a gumik? Ellenőrizzük a kerékgeometriát, és beállítjuk a futóművet."],
    ["Zgomote, vibrații, scurgeri sau revizie amânată? Verificăm mașina, stabilim prioritățile și îți explicăm ce trebuie rezolvat.", "Zaj, rezgés, szivárgás vagy elmaradt szerviz? Ellenőrizzük az autót, sorrendet állítunk, és elmondjuk, mit érdemes megoldani."],
    ["Dacă aerul nu mai răcește, apare miros neplăcut sau sistemul pierde agent frigorific, identificăm cauza și reparăm instalația de climatizare.", "Ha a klíma nem hűt, kellemetlen szagot áraszt vagy hűtőközeget veszít, megkeressük az okot és javítjuk a rendszert."],
    ["Ai vibrații, presiune care scade sau anvelope uzate neuniform? Verificăm roțile pentru rulare stabilă, frânare bună și uzură controlată.", "Vibrációt érzel, csökken a nyomás, vagy egyenetlenül kopnak az abroncsok? Ellenőrizzük a kerekeket a stabil futásért, biztonságos fékezésért és kontrollált kopásért."],
    ["Auzi zgomote la frânare, simți vibrații sau mașina este instabilă? Verificăm frânele și suspensia, pentru ca mașina să oprească și să vireze predictibil.", "Zajt hallasz fékezéskor, vibrációt érzel, vagy instabil az autó? Ellenőrizzük a féket és a futóművet, hogy az autó kiszámíthatóan álljon meg és kanyarodjon."],
    ["Găsește rapid serviciul potrivit, vezi când este recomandat și află cum abordăm verificarea înainte de intervenție.", "Találd meg gyorsan a megfelelő szolgáltatást, nézd meg mikor ajánlott, és tudd meg, hogyan ellenőrzünk javítás előtt."],
    ["Pentru companii, timpul pierdut în service înseamnă costuri. Organizăm programările, prioritizăm lucrările și ținem flota pregătită pentru lucru.", "Cégeknél a szervizben töltött idő költséget jelent. Megszervezzük az időpontokat, priorizáljuk a munkákat, és segítünk a flottát munkára készen tartani."],
    ["Planificăm vizitele astfel încât vehiculele să stea cât mai puțin în service.", "Úgy tervezzük a látogatásokat, hogy a járművek minél kevesebb időt töltsenek szervizben."],
    ["Lucrăm pe autoturisme și utilitare ușoare, cu verificare tehnică atentă.", "Személyautókkal és könnyű haszonjárművekkel dolgozunk, alapos műszaki ellenőrzéssel."],
    ["Știi ce este urgent, ce poate fi planificat și ce costuri trebuie anticipate.", "Látod, mi sürgős, mit lehet későbbre tervezni, és milyen költségekkel kell számolni."],
    ["Ai aproape un service cu experiență pentru intervențiile curente ale flotei.", "Helyben elérhető, tapasztalt szervizpartnered van a flotta mindennapi munkáihoz."],
    ["Lucrăm etapizat, ca să știi ce se verifică, ce se recomandă și ce decizie ai de luat înainte de reparație.", "Lépésről lépésre dolgozunk, hogy tudd, mit ellenőrzünk, mit javaslunk, és miről kell döntened javítás előtt."],
    ["Ne spui ce ai observat și stabilim momentul potrivit pentru verificare.", "Elmondod, mit tapasztaltál, mi pedig egyeztetjük az ellenőrzés megfelelő időpontját."],
    ["Verificăm simptomele și căutăm cauza, nu doar efectul vizibil.", "Ellenőrizzük a tüneteket, és az okot keressük, nem csak a látható következményt."],
    ["Decizie înainte de lucrare", "Döntés javítás előtt"],
    ["Îți explicăm ce am găsit, ce recomandăm și ce presupune intervenția.", "Elmagyarázzuk, mit találtunk, mit javaslunk, és mit jelent a beavatkozás."],
    ["Lucrare și control final", "Munka és végső ellenőrzés"],
    ["Executăm lucrarea agreată, verificăm rezultatul și îți spunem ce merită urmărit.", "Elvégezzük az egyeztetett munkát, ellenőrizzük az eredményt, és elmondjuk, mire érdemes figyelni."],
    ["Un service auto local unde lucrurile sunt explicate înainte să fie făcute", "Helyi autószerviz, ahol előbb elmagyarázzuk, aztán dolgozunk"],
    ["La Motorpext, constatarea vine înaintea presupunerilor. Îți spunem ce am găsit, ce recomandăm și ce merită făcut pentru ca mașina să funcționeze corect.", "A Motorpextnél a hibafeltárás megelőzi a találgatást. Elmondjuk, mit találtunk, mit javaslunk, és mit érdemes megtenni, hogy az autó megfelelően működjön."],
    ["Ani de lucru cu probleme reale, pe mașini și sisteme diferite.", "Évek tapasztalata valódi hibákkal, különböző autókon és rendszereken."],
    ["O echipă atentă la constatare, execuție și verificarea finală.", "Csapat, amely figyel a hibafeltárásra, a kivitelezésre és a végső ellenőrzésre."],
    ["Verificări potrivite pentru mașini actuale și sisteme complexe.", "A mai autókhoz és összetett rendszerekhez illő ellenőrzések."],
    ["Costuri explicate", "Elmagyarázott költségek"],
    ["Discutăm lucrarea înainte, ca să știi pentru ce plătești.", "A munka előtt átbeszéljük a részleteket, hogy tudd, miért fizetsz."],
    ["Intervenții justificate", "Indokolt beavatkozások"],
    ["Recomandăm lucrări care au sens tehnic pentru problema mașinii.", "Olyan munkát javaslunk, amelynek műszaki értelme van az autó problémája alapján."],
    ["Comunicare fără presiune", "Nyomás nélküli kommunikáció"],
    ["Primești explicații simple și timp să decizi informat.", "Egyszerű magyarázatot és időt kapsz a tájékozott döntéshez."],
    ["Spune-ne ce ai observat la mașină. Îți indicăm următorul pas și programăm o vizită la service.", "Mondd el, mit tapasztaltál az autón. Javasoljuk a következő lépést, és egyeztetünk egy szervizlátogatást."],
    ["Dacă recunoști unul dintre aceste semne, o verificare la timp te poate ajuta să eviți reparații mai costisitoare.", "Ha ezek közül valamelyik tünetet felismered, egy időben elvégzett ellenőrzés segíthet elkerülni a drágább javításokat."],
    ["Scopul este să pleci cu mașina verificată, cu explicații clare și cu mai multă siguranță la volan.", "A cél, hogy ellenőrzött autóval, világos magyarázattal és nagyobb biztonságérzettel indulj tovább."],
    ["Știi dinainte pașii principali, iar după constatare primești explicațiile de care ai nevoie ca să decizi.", "Előre látod a fő lépéseket, a hibafeltárás után pedig megkapod a döntéshez szükséges magyarázatot."],
    ["Sună și spune-ne ce se întâmplă cu mașina. Îți recomandăm următorul pas și programăm o verificare.", "Hívj fel, és mondd el, mi történik az autóval. Javasoljuk a következő lépést, és időpontot egyeztetünk ellenőrzésre."],
    ["Unele probleme au cauze legate între ele. Aceste servicii pot completa verificarea în aceeași vizită.", "Egyes hibák összefüggenek egymással. Ezek a szolgáltatások ugyanazon látogatás során kiegészíthetik az ellenőrzést."],
    ["Este recomandat când apar simptome neobișnuite, când comportamentul mașinii se schimbă sau când vrei să verifici o problemă înainte să devină mai costisitoare.", "Akkor ajánlott, ha szokatlan tünetek jelennek meg, megváltozik az autó viselkedése, vagy még azelőtt szeretnél ellenőrizni egy problémát, hogy drágábbá válna."],
    ["Durata depinde de starea mașinii și de ce descoperim la constatare. După verificare îți comunicăm o estimare realistă.", "Az időtartam az autó állapotától és a hibafeltárás eredményétől függ. Ellenőrzés után reális becslést adunk."],
    ["Pentru o vizită mai rapidă și mai bine organizată, recomandăm să suni înainte sau să soliciți o programare.", "Gyorsabb és szervezettebb látogatáshoz érdemes előre telefonálni vagy időpontot kérni."],
    ["Da. Îți spunem ce am găsit, ce recomandăm și ce opțiuni ai înainte să înceapă lucrarea.", "Igen. A munka megkezdése előtt elmondjuk, mit találtunk, mit javaslunk, és milyen lehetőségeid vannak."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de diagnoză.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a diagnosztikához kapcsolódó területet."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de mecanică auto.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a mechanikai területet."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de electrică auto.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük az autóvillamossági területet."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de climatizare.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a klímarendszert."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de sistem de injecție.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a befecskendező rendszert."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de caroserie.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a karosszéria érintett részét."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de anvelope.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a kerekeket és abroncsokat."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de __term_anvelope__.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a kerekeket és abroncsokat."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de frâne și suspensie.", "Azzal kezdjük, amit az autón tapasztaltál, majd ellenőrizzük a féket és a futóművet."],
    ["Separăm simptomele importante de efectele secundare și stabilim prioritatea lucrărilor.", "Elválasztjuk a fontos tüneteket a mellékhatásoktól, és felállítjuk a munkák sorrendjét."],
    ["Lucrare agreată", "Egyeztetett munka"],
    ["Intervenim după ce ai înțeles opțiunile și ai confirmat direcția de lucru.", "Akkor avatkozunk be, miután megértetted a lehetőségeket és jóváhagytad a munka irányát."],
    ["Verificăm rezultatul și îți spunem ce recomandări sunt utile pentru perioada următoare.", "Ellenőrizzük az eredményt, és elmondjuk, milyen javaslatok hasznosak a következő időszakra."],
    ["O geometrie incorectă schimbă felul în care mașina stă pe drum: direcția devine imprecisă, anvelopele se pot uza prematur, iar condusul devine obositor. Măsurăm valorile, îți arătăm abaterile și reglăm acolo unde starea tehnică permite.", "A hibás geometria megváltoztatja, hogyan viselkedik az autó az úton: pontatlanabb lehet a kormányzás, gyorsabban kophatnak a gumik, és fárasztóbbá válhat a vezetés. Megmérjük az értékeket, megmutatjuk az eltéréseket, és ahol műszakilag lehetséges, beállítjuk a futóművet."],
    ["Un cod de eroare indică o direcție, nu un verdict. Îl corelăm cu simptomele mașinii și cu verificări tehnice, ca reparația să pornească de la date, nu de la presupuneri.", "Egy hibakód irányt mutat, nem végleges ítélet. Összevetjük az autó tüneteivel és műszaki ellenőrzésekkel, hogy a javítás adatokból induljon ki, ne találgatásból."],
    ["O reparație bună începe cu o constatare corectă. Pornim de la simptomele pe care le simți la condus, verificăm componentele relevante și îți spunem ce este urgent, ce poate aștepta și ce lucrare rezolvă problema.", "Egy jó javítás korrekt hibafeltárással kezdődik. A vezetés közben tapasztalt tünetekből indulunk ki, ellenőrizzük a releváns alkatrészeket, és elmondjuk, mi sürgős, mi várhat, és milyen munka oldja meg a problémát."],
    ["Defecțiunile electrice pot apărea intermitent și pot avea cauze ascunse. Combinăm diagnoza cu testări pe circuit, ca să evităm înlocuirile inutile și să intervenim acolo unde trebuie.", "Az elektromos hibák időszakosan jelentkezhetnek, és rejtett okuk is lehet. A diagnosztikát áramköri ellenőrzésekkel kombináljuk, hogy elkerüljük a felesleges cseréket, és ott avatkozzunk be, ahol kell."],
    ["Răcirea slabă nu înseamnă automat doar lipsă de freon. Poate fi o pierdere, o presiune incorectă sau o componentă care nu mai lucrează bine. De aceea verificăm instalația înainte să recomandăm încărcarea.", "A gyenge hűtés nem jelenti automatikusan azt, hogy csak freon hiányzik. Lehet szivárgás, hibás nyomás vagy rosszul működő alkatrész is. Ezért ellenőrizzük a rendszert, mielőtt töltést javaslunk."],
    ["Sistemul de climatizare depinde de presiune, etanșeitate, senzori, compresor, ventilatoare și comandă electrică. Verificăm logic fiecare zonă, ca reparația să trateze cauza, nu doar simptomul.", "A klímarendszer működése a nyomástól, tömítettségtől, érzékelőktől, kompresszortól, ventilátoroktól és elektromos vezérléstől is függ. Logikusan ellenőrizzük a területeket, hogy a javítás az okot kezelje, ne csak a tünetet."],
    ["Fiecare daună cere o abordare diferită: îndreptare, pregătire, vopsire locală sau înlocuire. Evaluăm zona afectată și alegem varianta care poate oferi un rezultat curat și durabil.", "Minden sérülés más megközelítést igényel: egyengetést, előkészítést, helyi fényezést vagy cserét. Felmérjük az érintett részt, és azt a megoldást választjuk, amely tiszta és tartós eredményt adhat."],
    ["Anvelopele sunt contactul direct cu drumul. Starea lor influențează frânarea, stabilitatea, confortul și consumul. Verificăm roțile și îți recomandăm lucrările necesare pentru rulare sigură.", "Az abroncs az autó közvetlen kapcsolata az úttal. Állapota hat a fékezésre, stabilitásra, kényelemre és fogyasztásra. Ellenőrizzük a kerekeket, és javasoljuk a biztonságos futáshoz szükséges munkákat."],
    ["Frânele și suspensia influențează direct oprirea, stabilitatea și controlul mașinii. Inspectăm componentele importante, identificăm uzura și îți spunem ce trebuie rezolvat pentru siguranță.", "A fék és a futómű közvetlenül befolyásolja a megállást, stabilitást és irányíthatóságot. Megvizsgáljuk a fontos alkatrészeket, azonosítjuk a kopást, és elmondjuk, mit kell megoldani a biztonságért."],
    ["Verificăm poziția roților și identificăm abaterea care poate provoca instabilitate sau uzură neuniformă.", "Ellenőrizzük a kerekek helyzetét, és megkeressük az eltérést, amely instabilitást vagy egyenetlen kopást okozhat."],
    ["Corectăm unghiurile pentru o direcție mai precisă și o mașină mai ușor de controlat.", "Beállítjuk a szögeket a pontosabb kormányzásért és könnyebben irányítható autóért."],
    ["Dacă valorile nu pot fi corectate, căutăm semne de uzură la direcție, suspensie sau anvelope.", "Ha az értékek nem állíthatók be megfelelően, kopásnyomokat keresünk a kormányzásnál, futóműnél vagy abroncsoknál."],
    ["Primești o explicație scurtă și concretă: ce am găsit, ce am reglat și ce merită urmărit.", "Rövid és konkrét magyarázatot kapsz: mit találtunk, mit állítottunk be, és mire érdemes figyelni."],
    ["Ne spui ce simți la volan și verificăm elementele care pot influența geometria.", "Elmondod, mit érzel vezetés közben, mi pedig ellenőrizzük a geometriát befolyásoló elemeket."],
    ["Citirea valorilor arată unde este abaterea și cât de mult afectează rularea.", "A mért értékek megmutatják, hol van eltérés, és mennyire befolyásolja a futást."],
    ["Aducem unghiurile în parametri atunci când mașina permite reglajul corect.", "A szögeket paraméterbe hozzuk, ha az autó műszaki állapota lehetővé teszi a korrekt beállítást."],
    ["Verificăm rezultatul și îți spunem dacă există alte lucrări recomandate.", "Ellenőrizzük az eredményt, és elmondjuk, ha más munka is ajánlott."],
    ["Completăm agentul frigorific doar când verificările arată că intervenția este justificată.", "Csak akkor pótoljuk a hűtőközeget, ha az ellenőrzések alapján a beavatkozás indokolt."],
    ["Dacă instalația pierde agent frigorific, o simplă reîncărcare poate ține puțin. Verificarea cauzei te ajută să eviți drumuri repetate la service.", "Ha a rendszer hűtőközeget veszít, az egyszerű újratöltés csak rövid ideig segíthet. Az ok ellenőrzése segít elkerülni az ismételt szervizlátogatást."],
    ["Direcția corect reglată ajută mașina să rămână predictibilă la schimbări de bandă, frânare și viraje.", "A jól beállított futómű segít, hogy az autó kiszámítható maradjon sávváltásnál, fékezésnél és kanyarban."],
    ["O geometrie corectă reduce solicitarea inutilă a anvelopelor și ajută la o uzură mai echilibrată.", "A helyes geometria csökkenti a gumik felesleges terhelését, és egyenletesebb kopást segít."],
    ["Mașina se simte mai așezată pe drum, mai ales la viteze mai mari sau pe trasee lungi.", "Az autó stabilabbnak érződik az úton, főleg nagyobb sebességnél vagy hosszabb útvonalon."],
    ["Când roțile rulează corect, mașina nu lucrează împotriva propriei geometrii.", "Ha a kerekek megfelelően futnak, az autó nem dolgozik a saját geometriája ellen."],
    ["Corectarea abaterilor reduce solicitările care pot afecta în timp componentele de direcție și suspensie.", "Az eltérések korrigálása csökkenti azokat a terheléseket, amelyek idővel a kormányzás és futómű elemeit érinthetik."],
    ["Sistemul verificat corect poate răci mai bine și mai constant în zilele calde.", "A megfelelően ellenőrzött rendszer meleg napokon jobban és egyenletesebben hűthet."],
    ["O climă funcțională face drumurile mai plăcute și ajută la dezaburire când ai nevoie.", "A működő klíma kényelmesebbé teszi az utakat, és szükség esetén a páramentesítésben is segít."],
    ["Verificarea presiunii și a funcționării ajută la evitarea solicitării inutile a compresorului.", "A nyomás és működés ellenőrzése segít elkerülni a kompresszor felesleges terhelését."],
    ["Testăm răspunsul instalației, nu doar completarea cu agent frigorific.", "A rendszer működését teszteljük, nem csak hűtőközeget töltünk."],
    ["Știi dacă este suficientă încărcarea sau dacă există o problemă care trebuie reparată.", "Megtudod, elég-e a töltés, vagy van-e javítandó hiba."],
    ["Sistemul de climatizare reparat corect îți oferă aer rece, curat și constant.", "A korrektül javított klímarendszer hideg, tiszta és egyenletes levegőt ad."],
    ["Intervenția urmărește cauza problemei, nu o soluție temporară.", "A beavatkozás a probléma okát célozza, nem ideiglenes megoldást."],
    ["Verificarea pas cu pas arată ce componentă trebuie reparată sau înlocuită.", "A lépésenkénti ellenőrzés megmutatja, melyik alkatrészt kell javítani vagy cserélni."],
    ["Când cauza este identificată, scade riscul să revii cu aceeași problemă.", "Ha az ok megvan, kisebb az esélye, hogy ugyanazzal a hibával vissza kell térni."],
    ["Diagnoza corelată cu simptomele scurtează drumul de la problemă la soluție.", "A tünetekkel összevetett diagnosztika lerövidíti az utat a hibától a megoldásig."],
    ["Înțelegi ce înseamnă eroarea și ce opțiuni ai înainte de reparație.", "Megérted, mit jelent a hiba, és milyen lehetőségeid vannak javítás előtt."],
    ["O constatare bună reduce riscul schimbărilor de piese făcute din presupuneri.", "A jó hibafeltárás csökkenti a találgatásból végzett alkatrészcserék kockázatát."],
    ["Intervenția pornește de la date și verificări, nu de la ghicit.", "A beavatkozás adatokból és ellenőrzésekből indul ki, nem találgatásból."],
    ["Primești explicații pe înțeles, ca să știi ce se întâmplă cu mașina.", "Érthető magyarázatot kapsz, hogy tudd, mi történik az autóval."],
    ["Componentele verificate și întreținute corect fac mașina mai sigură în utilizarea zilnică.", "A megfelelően ellenőrzött és karbantartott alkatrészek biztonságosabbá teszik az autót a mindennapokban."],
    ["Lucrările făcute la timp pot preveni defecțiuni mai mari și costuri neprevăzute.", "Az időben elvégzett munkák megelőzhetik a nagyobb hibákat és váratlan költségeket."],
    ["O problemă rezolvată corect protejează piesele care lucrează împreună.", "A jól megoldott hiba védi az együtt dolgozó alkatrészeket is."],
    ["Știi ce lucrare este necesară și de ce apare în deviz.", "Tudod, milyen munka szükséges, és miért szerepel az árajánlatban."],
    ["Lucrăm pe mărci și modele diferite, cu abordare adaptată fiecărei mașini.", "Különböző márkákkal és modellekkel dolgozunk, az adott autóhoz igazított megközelítéssel."],
    ["Testările electrice reduc riscul unei intervenții pe componenta greșită.", "Az elektromos tesztek csökkentik annak kockázatát, hogy rossz alkatrészen történjen beavatkozás."],
    ["Circuitul verificat corect ajută sistemele electrice să funcționeze predictibil.", "A korrektül ellenőrzött áramkör segíti az elektromos rendszerek kiszámítható működését."],
    ["Căutăm cauza simptomelor intermitente, nu doar ștergem erori.", "Az időszakos tünetek okát keressük, nem csak hibakódokat törlünk."],
    ["Îți spunem ce este important acum și ce poate fi urmărit în timp.", "Elmondjuk, mi fontos most, és mit érdemes később figyelni."],
    ["O reparație de caroserie bine făcută readuce mașina mai aproape de aspectul dorit.", "A jól elvégzett karosszériajavítás közelebb hozza az autót a kívánt megjelenéshez."],
    ["Alegem metoda de lucru potrivită pentru tipul și zona daunei.", "A sérülés típusához és helyéhez illő munkamódszert választjuk."],
    ["Pregătirea și repararea corectă ajută la protejarea zonei afectate.", "A helyes előkészítés és javítás segít védeni az érintett felületet."],
    ["Înainte de lucrare știi ce se poate repara și ce rezultat este realist.", "A munka előtt tudod, mi javítható, és milyen eredmény reális."],
    ["Lucrările sunt făcute cu atenție la detalii și la aspectul final.", "A munkák figyelemmel készülnek a részletekre és a végső megjelenésre."],
    ["Roțile verificate corect ajută mașina să se simtă mai sigură pe drum.", "A megfelelően ellenőrzött kerekek biztonságosabb úttartást adnak."],
    ["Anvelopele în stare bună contribuie direct la distanța și controlul la frânare.", "A jó állapotú abroncsok közvetlenül hozzájárulnak a féktávhoz és a fékezés kontrolljához."],
    ["Verificarea roților ajută la depistarea problemelor care duc la uzură prematură.", "A kerekek ellenőrzése segít felismerni a korai kopást okozó problémákat."],
    ["Roțile echilibrate și anvelopele potrivite reduc vibrațiile și zgomotele la rulare.", "A kiegyensúlyozott kerekek és megfelelő abroncsok csökkentik a vibrációt és a menet zaját."],
    ["Frânele și suspensia în stare bună ajută mașina să reacționeze corect în situații importante.", "A jó állapotú fék és futómű segít, hogy az autó fontos helyzetekben megfelelően reagáljon."],
    ["Un sistem de frânare verificat îți oferă mai mult control în trafic.", "Az ellenőrzött fékrendszer nagyobb kontrollt ad a forgalomban."],
    ["Suspensia și direcția influențează modul în care anvelopele se uzează.", "A futómű és a kormányzás befolyásolja, hogyan kopnak az abroncsok."],
    ["Înțelegi ce componentă este afectată și de ce recomandăm intervenția.", "Megérted, melyik alkatrész érintett, és miért javasoljuk a beavatkozást."],
    ["Verificăm simptomele și datele relevante înainte să recomandăm o lucrare pe sistemul de injecție.", "A befecskendező rendszeren javasolt munka előtt ellenőrizzük a tüneteket és a releváns adatokat."],
    ["Îți spunem ce merită reparat și ce trebuie urmărit, fără intervenții inutile.", "Elmondjuk, mit érdemes javítani és mire kell figyelni, felesleges beavatkozások nélkül."],
    ["Un sistem de injecție verificat corect ajută motorul să funcționeze mai curat și mai stabil.", "A korrektül ellenőrzött befecskendező rendszer tisztább és stabilabb motorműködést segít."],
    ["Când injecția lucrează corect, motorul poate folosi combustibilul mai eficient.", "Ha a befecskendezés jól működik, a motor hatékonyabban használhatja az üzemanyagot."],
    ["Ai parte de o abordare tehnică dedicată sistemelor de injecție diesel.", "Dízel befecskendező rendszerekhez illő, célzott műszaki megközelítést kapsz."],
  ...
  const en = [
    ["Str. Santăului nr. 1, Oradea", "1 Santăului Street, Oradea"],
    ["Service auto Oradea · Autorizat R.A.R.", "Auto repair Oradea · R.A.R. authorized"],
    ["Service auto autorizat R.A.R. în Oradea, cu experiență din 1994 și servicii multimarcă pentru întreținere și reparații auto.", "R.A.R.-authorized auto repair workshop in Oradea, active since 1994, with multi-brand maintenance and repair services."],
    ["Încărcare freon în Oradea cu verificarea instalației de climă. Evaluare pentru încărcare corectă sau identificarea pierderilor.", "Freon refill in Oradea with AC system checks. Technical assessment for correct refill or leak identification."],
    ["Când se recomandă verificarea climei auto?", "When is an AC system check recommended?"],
    ["Dacă instalația pierde agent frigorific, o simplă reîncărcare poate ține puțin. Verificarea cauzei reduce riscul vizitelor repetate la service.", "If the system loses refrigerant, a simple refill may not last. Checking the cause reduces the risk of repeated workshop visits."],
    ["Este recomandată o verificare periodică, mai ales înainte de sezonul cald sau când eficiența de răcire scade.", "Periodic checks are recommended, especially before the warm season or when cooling efficiency drops."],
    ["Se poate circula cu clima defectă?", "Can the car be driven with faulty AC?"],
    ["Da, însă verificarea instalației este recomandată. Unele probleme pot afecta confortul, dezaburirea și durata de viață a compresorului.", "Yes, but a system check is recommended. Some issues can affect comfort, demisting and compressor life."],
    ["Verificare injecție Oradea | MOTORPEXT", "Injection System Check Oradea | MOTORPEXT"],
    ["Verificare injecție în Oradea pentru pornire greoaie, fum, consum crescut sau motor neregulat. Constatare tehnică și recomandări clare.", "Injection system check in Oradea for hard starting, smoke, increased consumption or irregular engine operation. Technical inspection and clear recommendations."],
    ["Service injecție Oradea", "Injection service Oradea"],
    ["Verificare specializată", "Specialized check"],
    ["Abordare tehnică atentă pentru sistemele de injecție diesel.", "Careful technical approach for diesel injection systems."],
    ["Constatare tehnică, reparații multimarcă și întreținere auto realizate cu deviz clar, comunicare transparentă și lucrări verificate.", "Technical inspection, multi-brand repairs and vehicle maintenance with clear estimates, transparent communication and checked work."],
    ["Servicii auto prezentate clar, cu verificări tehnice, recomandări profesioniste și lucrări stabilite înainte de reparație.", "Clearly presented auto services with technical checks, professional recommendations and work agreed before repair."],
    ["Pentru companii, timpul pierdut în service înseamnă costuri. Programările sunt organizate, lucrările sunt prioritizate, iar flota rămâne pregătită pentru activitatea zilnică.", "For companies, workshop downtime means cost. Appointments are organized, work is prioritized and the fleet stays ready for daily operations."],
    ["Programare flotă", "Fleet appointment"],
    ["Un service local cu experiență susține lucrările curente ale flotei.", "An experienced local workshop supports regular fleet work."],
    ["Proces clar, de la programare și constatare până la deviz, lucrare și control final.", "A clear process from appointment and inspection to estimate, work and final check."],
    ["Programarea se face telefonic, cu detalii despre mașină și lucrarea solicitată.", "Appointments are made by phone, with details about the vehicle and requested work."],
    ["Mașina este verificată pe baza sistemului vizat, a datelor disponibile și a componentelor relevante.", "The vehicle is checked based on the targeted system, available data and relevant components."],
    ["Recomandarea tehnică, costurile și prioritățile sunt comunicate înainte de începerea lucrării.", "The technical recommendation, costs and priorities are communicated before work begins."],
    ["Lucrarea agreată este executată, iar rezultatul este verificat înainte de predarea mașinii.", "The agreed work is completed, and the result is checked before the vehicle is handed over."],
    ["Service auto local, cu deviz clar și lucrări verificate", "Local auto workshop with clear estimates and checked work"],
    ["La Motorpext, constatarea tehnică este baza fiecărei recomandări. Lucrările sunt stabilite transparent, în funcție de starea mașinii, prioritatea reparației și siguranța în utilizare.", "At Motorpext, technical inspection is the basis of every recommendation. Work is defined transparently according to vehicle condition, repair priority and operating safety."],
    ["Costuri transparente", "Transparent costs"],
    ["Devizul este comunicat înainte de lucrare, cu priorități clare.", "The estimate is communicated before work begins, with clear priorities."],
    ["Lucrări justificate tehnic", "Technically justified work"],
    ["Recomandările sunt făcute în funcție de constatarea mașinii.", "Recommendations are made based on the vehicle inspection."],
    ["Informațiile importante sunt transmise direct, profesionist și ușor de urmărit.", "Important information is provided directly, professionally and clearly."],
    ["Pentru zgomote, erori, pierderi de lichide sau comportament neobișnuit, programarea la service se face telefonic.", "For noises, errors, fluid leaks or unusual behavior, service appointments are made by phone."],
    ["Programarea, disponibilitatea și detaliile despre lucrare se stabilesc telefonic cu atelierul Motorpext.", "Appointments, availability and work details are arranged by phone with the Motorpext workshop."],
    ["Lucrările urgente, cele planificabile și costurile anticipate sunt comunicate transparent.", "Urgent work, planned work and expected costs are communicated transparently."],
    ["Semne", "Signs"],
    ["Deviz și recomandare", "Estimate and recommendation"],
    ["Preluare și verificare", "Intake and check"],
    ["Lucrare justificată tehnic", "Technically justified work"],
    ["Impact cu bordură sau groapă", "Curb or pothole impact"],
    ["Componente de direcție sau suspensie schimbate", "Replaced steering or suspension components"],
    ["Instalație neverificată de mult timp", "AC system not checked for a long time"],
    ["Reglajul este recomandat când mașina trage într-o parte, volanul nu stă drept, anvelopele se uzează neuniform sau după lucrări la direcție ori suspensie.", "Alignment is recommended when the car pulls to one side, the steering wheel is off-center, tires wear unevenly, or after steering or suspension work."],
    ["O climă funcțională contribuie la confort și ajută la dezaburire atunci când este necesar.", "A working AC system supports comfort and helps with demisting when needed."],
    ["Se stabilește dacă este suficientă încărcarea sau dacă există o defecțiune care trebuie reparată.", "It is established whether refilling is enough or whether there is a fault that needs repair."],
    ["Răcirea este confirmată, iar eventualele recomandări sunt comunicate clar.", "Cooling is confirmed, and any recommendations are communicated clearly."],
    ["Aceste semne arată că mașina are nevoie de o verificare tehnică înainte ca defecțiunea să genereze costuri mai mari.", "These signs show that the vehicle needs a technical check before the fault creates higher costs."],
    ["Detalii tehnice", "Technical details"],
    ["Scopul este o mașină verificată corect, cu lucrări justificate tehnic și cu mai multă siguranță în utilizare.", "The goal is a correctly checked vehicle, technically justified work and safer use."],
    ["Pașii principali sunt clari de la început: constatare, deviz, lucrare și control final.", "The main steps are clear from the start: inspection, estimate, work and final check."],
    ["Pentru verificare tehnică și programare la service, contactul se face telefonic.", "For technical checks and workshop appointments, contact is made by phone."],
    ["Verificarea pornește de la comportamentul mașinii și de la componentele relevante pentru", "The check starts from vehicle behavior and the components relevant to"],
    ["Cauza reală este stabilită înainte de recomandarea înlocuirilor sau a lucrărilor mai costisitoare.", "The real cause is established before recommending replacements or more expensive work."],
    ["Lucrarea începe după clarificarea motivului tehnic, a pieselor vizate și a rezultatului urmărit.", "Work begins after the technical reason, targeted parts and expected result are clarified."],
    ["La final sunt comunicate lucrările efectuate, observațiile tehnice și recomandările pentru perioada următoare.", "At the end, completed work, technical observations and next-period recommendations are communicated."],
    ["Comportamentul semnalat este analizat, apoi este verificată zona de", "The reported behavior is analyzed, then the following area is checked:"],
    ["Sunt identificate componentele relevante, cauza probabilă și prioritatea lucrărilor.", "Relevant components, the likely cause and work priority are identified."],
    ["Reparația începe după stabilirea opțiunilor și confirmarea direcției de lucru.", "Repair begins after the options and work direction are confirmed."],
    ["Rezultatul este verificat, iar recomandările tehnice pentru perioada următoare sunt comunicate clar.", "The result is checked, and technical recommendations for the next period are communicated clearly."],
    ["Este recomandat când comportamentul mașinii se schimbă, când apar zgomote, vibrații, erori sau când este necesară o verificare preventivă.", "It is recommended when vehicle behavior changes, when noises, vibrations or errors appear, or when a preventive check is needed."],
    ["Durata depinde de starea mașinii și de rezultatul constatării. După verificare se comunică o estimare realistă.", "Duration depends on vehicle condition and inspection results. After the check, a realistic estimate is communicated."],
    ["Pentru o vizită rapidă și bine organizată, programarea se face în prealabil.", "For a quick and well organized visit, appointments are made in advance."],
    ["Sunt comunicate recomandările înainte de reparație?", "Are recommendations communicated before repair?"],
    ["Da. Constatarea, recomandările tehnice și opțiunile disponibile sunt comunicate înainte de începerea lucrării.", "Yes. The inspection, technical recommendations and available options are communicated before work begins."],
    ["Valorile măsurate, reglajele efectuate și recomandările tehnice sunt comunicate clar.", "Measured values, completed adjustments and technical recommendations are communicated clearly."],
    ["Comportamentul mașinii la rulare este corelat cu elementele care pot influența geometria.", "Vehicle behavior while driving is correlated with elements that can influence geometry."],
    ["Agentul frigorific este completat doar când verificările confirmă că lucrarea este justificată tehnic.", "Refrigerant is added only when checks confirm the work is technically justified."],
    ["Funcționarea sistemului de climatizare este verificată înainte de completarea cu agent frigorific.", "AC system operation is checked before refrigerant is added."],
    ["Reîncărcarea se face doar când lucrarea este justificată tehnic.", "Refilling is done only when the work is technically justified."],
    ["Nu întotdeauna. Dacă există pierderi sau componente defecte, încărcarea fără verificare rezolvă doar temporar efectul vizibil.", "Not always. If there are leaks or faulty components, refilling without checking only temporarily solves the visible effect."],
    ["Martor aprins, pornire grea sau pierdere de putere? Erorile sunt citite, datele sunt corelate cu verificarea tehnică, iar cauza reală este stabilită înainte de reparație.", "Warning light, hard starting or loss of power? Fault codes are read, data is correlated with the technical check and the real cause is established before repair."],
    ["Datele din diagnoză sunt corelate cu verificarea tehnică a mașinii.", "Diagnostic data is correlated with the vehicle's technical check."],
    ["Un cod de eroare indică o direcție, nu un verdict. Codurile sunt corelate cu verificări tehnice, astfel încât reparația pornește de la date, nu de la presupuneri.", "A fault code points in a direction, but it is not a verdict. Codes are correlated with technical checks so repair starts from data, not assumptions."],
    ["Zgomote, vibrații, scurgeri sau revizie întârziată? Ansamblurile mecanice sunt verificate, prioritățile sunt stabilite, iar lucrările necesare sunt comunicate clar înainte de reparație.", "Noises, vibrations, leaks or delayed service? Mechanical assemblies are checked, priorities are set and the required work is communicated clearly before repair."],
    ["Constatare mecanică și deviz clar", "Mechanical inspection and clear estimate"],
    ["Lucrarea este stabilită pe baza verificării tehnice și a priorității componentelor.", "Work is defined based on technical checks and component priority."],
    ["O reparație bună începe cu o constatare corectă. Comportamentul mașinii la rulare este corelat cu verificarea componentelor relevante, pentru a stabili ce este urgent, ce poate fi planificat și ce lucrare rezolvă cauza.", "A good repair starts with a correct inspection. Vehicle behavior while driving is correlated with relevant component checks to define what is urgent, what can be planned and what work solves the cause."],
    ["Circuitul electric și componentele sunt testate înainte de recomandarea reparației.", "The electrical circuit and components are tested before repair is recommended."],
    ["Defecțiunile electrice pot apărea intermitent și pot avea cauze ascunse. Diagnoza este completată cu testări pe circuit, pentru identificarea corectă a componentelor afectate și evitarea înlocuirilor inutile.", "Electrical faults can appear intermittently and may have hidden causes. Diagnostics are completed with circuit testing to correctly identify affected components and avoid unnecessary replacements."],
    ["Problemele de injecție pot afecta pornirea, consumul, fumul și puterea motorului. Funcționarea sistemului și componentele relevante sunt verificate înainte de recomandarea reparației.", "Injection issues can affect starting, fuel consumption, smoke and engine power. System operation and relevant components are checked before repair is recommended."],
    ["Reparații transparente", "Transparent repairs"],
    ["Componenta afectată și motivul recomandării sunt comunicate clar.", "The affected component and the reason for the recommendation are communicated clearly."],
    ["Sunt verificate datele relevante înainte de recomandarea lucrării pe sistemul de injecție.", "Relevant data is checked before work on the injection system is recommended."],
    ["Sunt indicate lucrările justificate și aspectele care trebuie urmărite, fără operațiuni inutile.", "Justified work and items to monitor are indicated, without unnecessary operations."],
    ["Când apar semne de defecțiune, sunt necesare o constatare corectă, explicații clare și o intervenție făcută responsabil.", "When signs of a fault appear, a correct inspection, clear explanations and responsible repair work are needed."],
    ["Servicii structurate clar, cu informații despre situațiile în care sunt recomandate și despre modul de verificare înainte de intervenție.", "Clearly structured services, with information on when they are recommended and how checks are performed before repair."],
    ["Martor aprins, pornire grea sau pierdere de putere? Erorile sunt citite, simptomele sunt verificate, iar cauza reală este căutată înainte de reparație.", "Warning light, hard starting or loss of power? Fault codes are read, symptoms are checked and the real cause is investigated before repair."],
    ["Zgomote, vibrații, scurgeri sau revizie amânată? Mașina este verificată, prioritățile sunt stabilite, iar lucrările necesare sunt explicate clar.", "Noises, vibrations, leaks or overdue maintenance? The car is checked, priorities are set and the necessary work is explained clearly."],
    ["Probleme la pornire, senzori, baterie sau martori aprinși? Testăm sistemele electrice și izolăm cauza înainte de reparație.", "Starting issues, sensors, battery faults or warning lights? Electrical systems are tested and the cause is isolated before repair."],
    ["Lovituri, zgârieturi sau elemente deformate? Dauna este evaluată, metoda potrivită este stabilită, iar pașii lucrării sunt prezentați clar.", "Dents, scratches or deformed parts? The damage is assessed, the right method is defined and the work steps are presented clearly."],
    ["Vibrații, presiune care scade sau anvelope uzate neuniform? Roțile sunt verificate pentru rulare stabilă, frânare bună și uzură controlată.", "Vibrations, dropping pressure or uneven tire wear? Wheels are checked for stable driving, good braking and controlled wear."],
    ["Zgomote la frânare, vibrații sau instabilitate? Frânele și suspensia sunt verificate pentru oprire sigură și comportament predictibil.", "Braking noises, vibrations or instability? Brakes and suspension are checked for safe stopping and predictable behavior."],
    ["Lucrările urgente, cele planificabile și costurile anticipate sunt comunicate transparent.", "Urgent work, planned work and expected costs are communicated transparently."],
    ["Un service local cu experiență poate susține intervențiile curente ale flotei.", "An experienced local workshop can support regular fleet service work."],
    ["Proces etapizat, cu verificări clare, recomandări tehnice și decizii luate înainte de începerea reparației.", "A step-by-step process with clear checks, technical recommendations and decisions made before repair begins."],
    ["Simptomele observate sunt discutate, apoi se stabilește momentul potrivit pentru verificare.", "Observed symptoms are discussed, then the right time for inspection is scheduled."],
    ["Constatarea, recomandările și intervenția propusă sunt explicate înainte de lucru.", "The inspection, recommendations and proposed repair are explained before work begins."],
    ["Lucrarea agreată este executată, rezultatul este verificat, iar recomandările finale sunt comunicate clar.", "The agreed work is completed, the result is checked and final recommendations are communicated clearly."],
    ["La Motorpext, constatarea vine înaintea presupunerilor. Recomandările sunt făcute pe baza verificărilor, cu explicații clare și lucrări orientate spre funcționarea corectă a mașinii.", "At Motorpext, inspection comes before assumptions. Recommendations are based on checks, with clear explanations and work focused on correct vehicle operation."],
    ["Lucrarea este discutată înainte, cu explicații clare despre costuri.", "The work is discussed in advance, with clear explanations of costs."],
    ["Explicații clare, fără presiune inutilă și fără recomandări forțate.", "Clear explanations, without unnecessary pressure or forced recommendations."],
    ["Pentru simptome observate la mașină, următorul pas este o constatare clară și o programare la service.", "For symptoms observed on the car, the next step is a clear inspection and a workshop appointment."],
    ["Pentru disponibilitate, detalii despre lucrare sau programare, atelierul Motorpext poate fi contactat telefonic.", "For availability, work details or appointments, the Motorpext workshop can be contacted by phone."],
    ["Acest website prezintă informații despre serviciile SC MOTORPEXT SRL și include date de contact pentru solicitări de programare. Pentru întrebări privind datele personale, contactul se poate face la numerele afișate pe site.", "This website presents information about SC MOTORPEXT SRL services and includes contact details for appointment requests. For personal data questions, contact can be made using the phone numbers shown on the site."],
    ["Aceste semne indică faptul că o verificare la timp poate preveni reparații mai costisitoare.", "These signs indicate that a timely check can help prevent more expensive repairs."],
    ["Scopul este o mașină verificată corect, cu explicații clare și cu mai multă siguranță la utilizare.", "The goal is a correctly checked car, clear explanations and safer use."],
    ["Pașii principali sunt clari dinainte, iar după constatare sunt comunicate recomandările necesare pentru decizie.", "The main steps are clear in advance, and after inspection the recommendations needed for a decision are communicated."],
    ["Pentru simptome observate la mașină, se recomandă o constatare tehnică și o programare pentru verificare.", "For symptoms observed on the car, a technical inspection and a workshop appointment are recommended."],
    ["Este recomandat când apar simptome neobișnuite, când comportamentul mașinii se schimbă sau când o problemă trebuie verificată înainte să devină mai costisitoare.", "It is recommended when unusual symptoms appear, when vehicle behavior changes, or when an issue should be checked before it becomes more expensive."],
    ["Durata depinde de starea mașinii și de ce se descoperă la constatare. După verificare se poate comunica o estimare realistă.", "Duration depends on vehicle condition and what is found during inspection. After the check, a realistic estimate can be provided."],
    ["Este necesară programarea?", "Is an appointment required?"],
    ["Pentru o vizită mai rapidă și mai bine organizată, este recomandată programarea în prealabil.", "For a faster and better organized visit, scheduling in advance is recommended."],
    ["Sunt explicate recomandările înainte de reparație?", "Are recommendations explained before repair?"],
    ["Da. Constatarea, recomandările și opțiunile disponibile sunt comunicate înainte de începerea lucrării.", "Yes. The inspection, recommendations and available options are communicated before work begins."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru diagnoză.", "The check starts from observed symptoms and components relevant to diagnostics."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru mecanică auto.", "The check starts from observed symptoms and components relevant to mechanical repair."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru electrică auto.", "The check starts from observed symptoms and components relevant to auto electrical systems."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru climatizare.", "The check starts from observed symptoms and components relevant to the AC system."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru sistem de injecție.", "The check starts from observed symptoms and components relevant to the injection system."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru caroserie.", "The check starts from observed symptoms and components relevant to bodywork."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru anvelope.", "The check starts from observed symptoms and components relevant to wheels and tires."],
    ["Verificarea pornește de la simptomele observate și de la componentele relevante pentru frâne și suspensie.", "The check starts from observed symptoms and components relevant to brakes and suspension."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de diagnoză.", "Observed symptoms are analyzed, then the diagnostics area is checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de mecanică auto.", "Observed symptoms are analyzed, then the mechanical area is checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de electrică auto.", "Observed symptoms are analyzed, then the auto electrical area is checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de climatizare.", "Observed symptoms are analyzed, then the AC system is checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de sistem de injecție.", "Observed symptoms are analyzed, then the injection system is checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de caroserie.", "Observed symptoms are analyzed, then the affected bodywork area is checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de anvelope.", "Observed symptoms are analyzed, then wheels and tires are checked."],
    ["Simptomele observate sunt analizate, apoi este verificată zona de frâne și suspensie.", "Observed symptoms are analyzed, then brakes and suspension are checked."],
    ["Urmărim motivul real al problemei înainte să recomandăm înlocuiri sau lucrări mai costisitoare.", "The real cause is checked before recommending replacements or more expensive work."],
    ["Lucrarea agreată începe după clarificarea intervenției, a motivului tehnic și a rezultatului urmărit.", "The agreed work begins after the intervention, technical reason and expected result are clarified."],
    ["La final sunt comunicate indicații clare despre ce merită urmărit și ce poate fi planificat mai departe.", "At the end, clear guidance is provided on what should be monitored and what can be planned later."],
    ["Intervenția începe după stabilirea opțiunilor și confirmarea direcției de lucru.", "The intervention begins after the options and direction of work are confirmed."],
    ["Rezultatul este verificat, iar recomandările utile pentru perioada următoare sunt comunicate clar.", "The result is checked, and useful recommendations for the next period are communicated clearly."],
    ["Dacă sunt necesare reparații suplimentare, recomandările sunt comunicate clar.", "If additional repairs are needed, recommendations are communicated clearly."],
    ["Rezultatul este prezentat clar: ce s-a constatat, ce s-a reglat și ce merită urmărit.", "The result is presented clearly: what was found, what was adjusted and what should be monitored."],
    ["Simptomele observate la volan sunt corelate cu elementele care pot influența geometria.", "Symptoms observed at the wheel are correlated with elements that can influence geometry."],
    ["Rezultatul este verificat, iar eventualele lucrări recomandate sunt comunicate clar.", "The result is checked, and any recommended work is communicated clearly."],
    ["Un sistem de frânare verificat contribuie la mai mult control în trafic.", "A checked braking system supports better control in traffic."],
    ["Componenta afectată și motivul recomandării sunt explicate clar.", "The affected component and the reason for the recommendation are explained clearly."],
    ["Când mașina îți dă un semn, ai nevoie de o constatare corectă, explicații pe înțeles și o lucrare făcută responsabil.", "When your car shows a sign, you need a correct inspection, clear explanations and work done responsibly."],
    ["Clima nu mai răcește cum trebuie? Verificăm presiunea și starea instalației înainte de completarea cu agent frigorific.", "Is the AC no longer cooling properly? We check pressure and system condition before adding refrigerant."],
    ["Mașina trage într-o parte, volanul nu stă drept sau anvelopele se uzează neuniform? Verificăm geometria roților și readucem direcția în parametri.", "Does the car pull to one side, is the steering wheel off-center, or are the tires wearing unevenly? We check wheel geometry and bring alignment back into spec."],
    ["Zgomote, vibrații, scurgeri sau revizie amânată? Verificăm mașina, stabilim prioritățile și îți explicăm ce trebuie rezolvat.", "Noises, vibrations, leaks or overdue maintenance? We inspect the car, set priorities and explain what needs to be fixed."],
    ["Dacă aerul nu mai răcește, apare miros neplăcut sau sistemul pierde agent frigorific, identificăm cauza și reparăm instalația de climatizare.", "If the air no longer cools, there is an unpleasant smell or the system loses refrigerant, we identify the cause and repair the AC system."],
    ["Ai vibrații, presiune care scade sau anvelope uzate neuniform? Verificăm roțile pentru rulare stabilă, frânare bună și uzură controlată.", "Do you feel vibrations, dropping pressure or uneven tire wear? We check the wheels for stable driving, safe braking and controlled wear."],
    ["Auzi zgomote la frânare, simți vibrații sau mașina este instabilă? Verificăm frânele și suspensia, pentru ca mașina să oprească și să vireze predictibil.", "Do you hear braking noises, feel vibrations or notice instability? We check brakes and suspension so the car stops and turns predictably."],
    ["Găsește rapid serviciul potrivit, vezi când este recomandat și află cum abordăm verificarea înainte de intervenție.", "Quickly find the right service, see when it is recommended and learn how we inspect before repair."],
    ["Pentru companii, timpul pierdut în service înseamnă costuri. Organizăm programările, prioritizăm lucrările și ținem flota pregătită pentru lucru.", "For companies, downtime in service means cost. We organize appointments, prioritize work and help keep the fleet ready for business."],
    ["Planificăm vizitele astfel încât vehiculele să stea cât mai puțin în service.", "We plan visits so vehicles spend as little time in service as possible."],
    ["Lucrăm pe autoturisme și utilitare ușoare, cu verificare tehnică atentă.", "We work on passenger cars and light commercial vehicles, with careful technical checks."],
    ["Știi ce este urgent, ce poate fi planificat și ce costuri trebuie anticipate.", "You know what is urgent, what can be planned and what costs should be anticipated."],
    ["Ai aproape un service cu experiență pentru intervențiile curente ale flotei.", "You have an experienced local service partner for regular fleet work."],
    ["Lucrăm etapizat, ca să știi ce se verifică, ce se recomandă și ce decizie ai de luat înainte de reparație.", "We work step by step, so you know what is checked, what is recommended and what decision is needed before repair."],
    ["Ne spui ce ai observat și stabilim momentul potrivit pentru verificare.", "You tell us what you noticed, and we schedule the right time for the check."],
    ["Verificăm simptomele și căutăm cauza, nu doar efectul vizibil.", "We check the symptoms and look for the cause, not just the visible effect."],
    ["Decizie înainte de lucrare", "Decision Before Work"],
    ["Îți explicăm ce am găsit, ce recomandăm și ce presupune intervenția.", "We explain what we found, what we recommend and what the intervention involves."],
    ["Lucrare și control final", "Work And Final Check"],
    ["Executăm lucrarea agreată, verificăm rezultatul și îți spunem ce merită urmărit.", "We carry out the agreed work, check the result and tell you what is worth monitoring."],
    ["Un service auto local unde lucrurile sunt explicate înainte să fie făcute", "A local auto service where things are explained before they are done"],
    ["La Motorpext, constatarea vine înaintea presupunerilor. Îți spunem ce am găsit, ce recomandăm și ce merită făcut pentru ca mașina să funcționeze corect.", "At Motorpext, inspection comes before assumptions. We tell you what we found, what we recommend and what is worth doing so the car works properly."],
    ["Ani de lucru cu probleme reale, pe mașini și sisteme diferite.", "Years of work with real issues across different cars and systems."],
    ["O echipă atentă la constatare, execuție și verificarea finală.", "A team focused on inspection, execution and final checks."],
    ["Verificări potrivite pentru mașini actuale și sisteme complexe.", "Checks suited to modern cars and complex systems."],
    ["Costuri explicate", "Explained Costs"],
    ["Discutăm lucrarea înainte, ca să știi pentru ce plătești.", "We discuss the work beforehand, so you know what you are paying for."],
    ["Intervenții justificate", "Justified Repairs"],
    ["Recomandăm lucrări care au sens tehnic pentru problema mașinii.", "We recommend work that makes technical sense for the car's issue."],
    ["Comunicare fără presiune", "No-Pressure Communication"],
    ["Primești explicații simple și timp să decizi informat.", "You get simple explanations and time to make an informed decision."],
    ["Spune-ne ce ai observat la mașină. Îți indicăm următorul pas și programăm o vizită la service.", "Tell us what you noticed about the car. We recommend the next step and schedule a service visit."],
    ["Dacă recunoști unul dintre aceste semne, o verificare la timp te poate ajuta să eviți reparații mai costisitoare.", "If you recognize one of these signs, a timely check can help you avoid more expensive repairs."],
    ["Scopul este să pleci cu mașina verificată, cu explicații clare și cu mai multă siguranță la volan.", "The goal is to leave with the car checked, clear explanations and more confidence behind the wheel."],
    ["Știi dinainte pașii principali, iar după constatare primești explicațiile de care ai nevoie ca să decizi.", "You know the main steps in advance, and after the inspection you get the explanations you need to decide."],
    ["Sună și spune-ne ce se întâmplă cu mașina. Îți recomandăm următorul pas și programăm o verificare.", "Call us and tell us what is happening with the car. We recommend the next step and schedule a check."],
    ["Unele probleme au cauze legate între ele. Aceste servicii pot completa verificarea în aceeași vizită.", "Some issues have connected causes. These services can complete the check during the same visit."],
    ["Este recomandat când apar simptome neobișnuite, când comportamentul mașinii se schimbă sau când vrei să verifici o problemă înainte să devină mai costisitoare.", "It is recommended when unusual symptoms appear, when the car's behavior changes, or when you want to check an issue before it becomes more expensive."],
    ["Durata depinde de starea mașinii și de ce descoperim la constatare. După verificare îți comunicăm o estimare realistă.", "Duration depends on the car's condition and what we find during inspection. After the check, we give you a realistic estimate."],
    ["Pentru o vizită mai rapidă și mai bine organizată, recomandăm să suni înainte sau să soliciți o programare.", "For a faster and better organized visit, we recommend calling ahead or requesting an appointment."],
    ["Da. Îți spunem ce am găsit, ce recomandăm și ce opțiuni ai înainte să înceapă lucrarea.", "Yes. Before the work starts, we tell you what we found, what we recommend and what options you have."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de diagnoză.", "We start with what you noticed about the car, then check the diagnostics area."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de mecanică auto.", "We start with what you noticed about the car, then check the mechanical area."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de electrică auto.", "We start with what you noticed about the car, then check the electrical area."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de climatizare.", "We start with what you noticed about the car, then check the AC system."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de sistem de injecție.", "We start with what you noticed about the car, then check the injection system."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de caroserie.", "We start with what you noticed about the car, then check the affected bodywork area."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de anvelope.", "We start with what you noticed about the car, then check the wheels and tires."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de __term_anvelope__.", "We start with what you noticed about the car, then check the wheels and tires."],
    ["Începem cu ce ai observat la mașină, apoi verificăm zona de frâne și suspensie.", "We start with what you noticed about the car, then check the brakes and suspension."],
    ["Separăm simptomele importante de efectele secundare și stabilim prioritatea lucrărilor.", "We separate important symptoms from secondary effects and set the work priorities."],
    ["Lucrare agreată", "Agreed Work"],
    ["Intervenim după ce ai înțeles opțiunile și ai confirmat direcția de lucru.", "We intervene after you understand the options and confirm the direction of work."],
    ["Verificăm rezultatul și îți spunem ce recomandări sunt utile pentru perioada următoare.", "We check the result and tell you what recommendations are useful for the next period."],
    ["O geometrie incorectă schimbă felul în care mașina stă pe drum: direcția devine imprecisă, anvelopele se pot uza prematur, iar condusul devine obositor. Măsurăm valorile, îți arătăm abaterile și reglăm acolo unde starea tehnică permite.", "Incorrect geometry changes how the car sits on the road: steering becomes less precise, tires can wear prematurely and driving becomes tiring. We measure the values, show you the deviations and adjust where the technical condition allows."],
    ["Un cod de eroare indică o direcție, nu un verdict. Îl corelăm cu simptomele mașinii și cu verificări tehnice, ca reparația să pornească de la date, nu de la presupuneri.", "An error code points in a direction, but it is not a verdict. We match it with the car's symptoms and technical checks so the repair starts from data, not assumptions."],
    ["O reparație bună începe cu o constatare corectă. Pornim de la simptomele pe care le simți la condus, verificăm componentele relevante și îți spunem ce este urgent, ce poate aștepta și ce lucrare rezolvă problema.", "A good repair starts with a correct inspection. We begin with the symptoms you feel while driving, check the relevant components and tell you what is urgent, what can wait and what work solves the issue."],
    ["Defecțiunile electrice pot apărea intermitent și pot avea cauze ascunse. Combinăm diagnoza cu testări pe circuit, ca să evităm înlocuirile inutile și să intervenim acolo unde trebuie.", "Electrical faults can appear intermittently and may have hidden causes. We combine diagnostics with circuit testing to avoid unnecessary replacements and intervene where needed."],
    ["Răcirea slabă nu înseamnă automat doar lipsă de freon. Poate fi o pierdere, o presiune incorectă sau o componentă care nu mai lucrează bine. De aceea verificăm instalația înainte să recomandăm încărcarea.", "Weak cooling does not automatically mean only low refrigerant. It can be a leak, incorrect pressure or a component that no longer works properly. That is why we check the system before recommending a recharge."],
    ["Sistemul de climatizare depinde de presiune, etanșeitate, senzori, compresor, ventilatoare și comandă electrică. Verificăm logic fiecare zonă, ca reparația să trateze cauza, nu doar simptomul.", "The AC system depends on pressure, sealing, sensors, compressor, fans and electrical control. We check each area logically so the repair treats the cause, not just the symptom."],
    ["Fiecare daună cere o abordare diferită: îndreptare, pregătire, vopsire locală sau înlocuire. Evaluăm zona afectată și alegem varianta care poate oferi un rezultat curat și durabil.", "Every damage case needs a different approach: straightening, preparation, local painting or replacement. We evaluate the affected area and choose the option that can deliver a clean and durable result."],
    ["Anvelopele sunt contactul direct cu drumul. Starea lor influențează frânarea, stabilitatea, confortul și consumul. Verificăm roțile și îți recomandăm lucrările necesare pentru rulare sigură.", "Tires are the car's direct contact with the road. Their condition affects braking, stability, comfort and consumption. We check the wheels and recommend the work needed for safe driving."],
    ["Frânele și suspensia influențează direct oprirea, stabilitatea și controlul mașinii. Inspectăm componentele importante, identificăm uzura și îți spunem ce trebuie rezolvat pentru siguranță.", "Brakes and suspension directly influence stopping, stability and vehicle control. We inspect the important components, identify wear and tell you what needs to be fixed for safety."],
    ["Verificăm poziția roților și identificăm abaterea care poate provoca instabilitate sau uzură neuniformă.", "We check wheel position and identify deviations that can cause instability or uneven wear."],
    ["Corectăm unghiurile pentru o direcție mai precisă și o mașină mai ușor de controlat.", "We correct the angles for more precise steering and a car that is easier to control."],
    ["Dacă valorile nu pot fi corectate, căutăm semne de uzură la direcție, suspensie sau anvelope.", "If the values cannot be corrected, we look for signs of wear in steering, suspension or tires."],
    ["Primești o explicație scurtă și concretă: ce am găsit, ce am reglat și ce merită urmărit.", "You get a short, concrete explanation: what we found, what we adjusted and what is worth monitoring."],
    ["Ne spui ce simți la volan și verificăm elementele care pot influența geometria.", "You tell us what you feel at the wheel, and we check the elements that can influence geometry."],
    ["Citirea valorilor arată unde este abaterea și cât de mult afectează rularea.", "The measured values show where the deviation is and how much it affects driving."],
    ["Aducem unghiurile în parametri atunci când mașina permite reglajul corect.", "We bring the angles into spec when the car allows a correct adjustment."],
    ["Verificăm rezultatul și îți spunem dacă există alte lucrări recomandate.", "We check the result and tell you whether any other work is recommended."],
    ["Completăm agentul frigorific doar când verificările arată că intervenția este justificată.", "We add refrigerant only when the checks show that the intervention is justified."],
    ["Dacă instalația pierde agent frigorific, o simplă reîncărcare poate ține puțin. Verificarea cauzei te ajută să eviți drumuri repetate la service.", "If the system loses refrigerant, a simple recharge may not last. Checking the cause helps you avoid repeated service visits."],
    ["Direcția corect reglată ajută mașina să rămână predictibilă la schimbări de bandă, frânare și viraje.", "Correct alignment helps the car remain predictable during lane changes, braking and cornering."],
    ["O geometrie corectă reduce solicitarea inutilă a anvelopelor și ajută la o uzură mai echilibrată.", "Correct geometry reduces unnecessary tire stress and helps wear stay more balanced."],
    ["Mașina se simte mai așezată pe drum, mai ales la viteze mai mari sau pe trasee lungi.", "The car feels more settled on the road, especially at higher speeds or on longer trips."],
    ["Când roțile rulează corect, mașina nu lucrează împotriva propriei geometrii.", "When the wheels run correctly, the car is not working against its own geometry."],
    ["Corectarea abaterilor reduce solicitările care pot afecta în timp componentele de direcție și suspensie.", "Correcting deviations reduces stresses that can affect steering and suspension components over time."],
    ["Sistemul verificat corect poate răci mai bine și mai constant în zilele calde.", "A properly checked system can cool better and more consistently on hot days."],
    ["O climă funcțională face drumurile mai plăcute și ajută la dezaburire când ai nevoie.", "A working AC makes trips more pleasant and helps with demisting when needed."],
    ["Verificarea presiunii și a funcționării ajută la evitarea solicitării inutile a compresorului.", "Checking pressure and operation helps avoid unnecessary compressor strain."],
    ["Testăm răspunsul instalației, nu doar completarea cu agent frigorific.", "We test the system's response, not just the refrigerant level."],
    ["Știi dacă este suficientă încărcarea sau dacă există o problemă care trebuie reparată.", "You know whether a recharge is enough or whether there is a problem that needs repair."],
    ["Sistemul de climatizare reparat corect îți oferă aer rece, curat și constant.", "A correctly repaired AC system gives you cold, clean and consistent air."],
    ["Intervenția urmărește cauza problemei, nu o soluție temporară.", "The intervention targets the cause of the problem, not a temporary fix."],
    ["Verificarea pas cu pas arată ce componentă trebuie reparată sau înlocuită.", "A step-by-step check shows which component needs to be repaired or replaced."],
    ["Când cauza este identificată, scade riscul să revii cu aceeași problemă.", "When the cause is identified, the risk of returning with the same problem is lower."],
    ["Diagnoza corelată cu simptomele scurtează drumul de la problemă la soluție.", "Diagnostics matched with symptoms shortens the path from problem to solution."],
    ["Înțelegi ce înseamnă eroarea și ce opțiuni ai înainte de reparație.", "You understand what the error means and what options you have before repair."],
    ["O constatare bună reduce riscul schimbărilor de piese făcute din presupuneri.", "A good inspection reduces the risk of replacing parts based on assumptions."],
    ["Intervenția pornește de la date și verificări, nu de la ghicit.", "The intervention starts from data and checks, not guessing."],
    ["Primești explicații pe înțeles, ca să știi ce se întâmplă cu mașina.", "You get clear explanations so you know what is happening with the car."],
    ["Componentele verificate și întreținute corect fac mașina mai sigură în utilizarea zilnică.", "Correctly checked and maintained components make the car safer in daily use."],
    ["Lucrările făcute la timp pot preveni defecțiuni mai mari și costuri neprevăzute.", "Work done on time can prevent bigger faults and unexpected costs."],
    ["O problemă rezolvată corect protejează piesele care lucrează împreună.", "A correctly solved issue also protects the parts working together."],
    ["Știi ce lucrare este necesară și de ce apare în deviz.", "You know what work is needed and why it appears in the estimate."],
    ["Lucrăm pe mărci și modele diferite, cu abordare adaptată fiecărei mașini.", "We work on different makes and models, with an approach adapted to each car."],
    ["Testările electrice reduc riscul unei intervenții pe componenta greșită.", "Electrical testing reduces the risk of intervening on the wrong component."],
    ["Circuitul verificat corect ajută sistemele electrice să funcționeze predictibil.", "A correctly checked circuit helps electrical systems work predictably."],
    ["Căutăm cauza simptomelor intermitente, nu doar ștergem erori.", "We look for the cause of intermittent symptoms, not just clear errors."],
    ["Îți spunem ce este important acum și ce poate fi urmărit în timp.", "We tell you what matters now and what can be monitored over time."],
    ["O reparație de caroserie bine făcută readuce mașina mai aproape de aspectul dorit.", "A well-done bodywork repair brings the car closer to the desired appearance."],
    ["Alegem metoda de lucru potrivită pentru tipul și zona daunei.", "We choose the right work method for the type and location of the damage."],
    ["Pregătirea și repararea corectă ajută la protejarea zonei afectate.", "Correct preparation and repair help protect the affected area."],
    ["Înainte de lucrare știi ce se poate repara și ce rezultat este realist.", "Before the work, you know what can be repaired and what result is realistic."],
    ["Lucrările sunt făcute cu atenție la detalii și la aspectul final.", "The work is done with attention to detail and final appearance."],
    ["Roțile verificate corect ajută mașina să se simtă mai sigură pe drum.", "Correctly checked wheels help the car feel safer on the road."],
    ["Anvelopele în stare bună contribuie direct la distanța și controlul la frânare.", "Tires in good condition directly contribute to braking distance and control."],
    ["Verificarea roților ajută la depistarea problemelor care duc la uzură prematură.", "Checking the wheels helps detect issues that lead to premature wear."],
    ["Roțile echilibrate și anvelopele potrivite reduc vibrațiile și zgomotele la rulare.", "Balanced wheels and suitable tires reduce vibration and road noise."],
    ["Frânele și suspensia în stare bună ajută mașina să reacționeze corect în situații importante.", "Brakes and suspension in good condition help the car react correctly in important situations."],
    ["Un sistem de frânare verificat îți oferă mai mult control în trafic.", "A checked braking system gives you more control in traffic."],
    ["Suspensia și direcția influențează modul în care anvelopele se uzează.", "Suspension and steering influence how tires wear."],
    ["Înțelegi ce componentă este afectată și de ce recomandăm intervenția.", "You understand which component is affected and why we recommend the intervention."],
    ["Verificăm simptomele și datele relevante înainte să recomandăm o lucrare pe sistemul de injecție.", "We check symptoms and relevant data before recommending work on the injection system."],
    ["Îți spunem ce merită reparat și ce trebuie urmărit, fără intervenții inutile.", "We tell you what is worth repairing and what should be monitored, without unnecessary interventions."],
    ["Un sistem de injecție verificat corect ajută motorul să funcționeze mai curat și mai stabil.", "A correctly checked injection system helps the engine run cleaner and more steadily."],
    ["Când injecția lucrează corect, motorul poate folosi combustibilul mai eficient.", "When injection works correctly, the engine can use fuel more efficiently."],
    ["Ai parte de o abordare tehnică dedicată sistemelor de injecție diesel.", "You get a technical approach dedicated to diesel injection systems."],
